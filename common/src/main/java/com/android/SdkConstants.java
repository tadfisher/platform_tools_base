...
public final class SdkConstants {
    ...
    /** An SDK Project's gradlew.bat file (i.e. gradlew for windows) */
    public static final String FN_GRADLE_WRAPPER_WIN = FN_GRADLE_WRAPPER_UNIX + ".bat"; //$NON-NLS-1$
    /** An SDK Project's appropriate gradlew file (OS dependant) */
    ...
    /** The root folder for all gradle files. */
    public static final String GRADLE_FOLDER = "gradle";

    /** Path of the gradle wrapper folder.
     *  This is an OS path, ending with a separator. */
    public static final String GRADLE_WRAPPER_FOLDER = GRADLE_FOLDER + File.separator + "wrapper" + File.separator;
