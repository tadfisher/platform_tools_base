...
public final class SdkConstants {
  ...
  public static final String ATTR_INDEX = "index";                     //$NON-NLS-1$
    ...
    public static final String ATTR_GRAVITY_LEFT = "left";      //$NON-NLS-1$
    public static final String ATTR_GRAVITY_RIGHT = "right";    //$NON-NLS-1$
    public static final String ATTR_GRAVITY_START = "start";    //$NON-NLS-1$
    public static final String ATTR_GRAVITY_END = "end";        //$NON-NLS-1$
