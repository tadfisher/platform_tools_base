...
public class CallHierarchyRenderer {
    ...
    private String formatToolTip(Call c) {
        ...
        String entryGlobal = TimeUtils.humanizeTime(c.getEntryGlobalTime(), span, unit);
        String entryThread = TimeUtils.humanizeTime(c.getEntryThreadTime(), span, unit);
        String exitGlobal = TimeUtils.humanizeTime(c.getExitGlobalTime(), span, unit);
        String exitThread = TimeUtils.humanizeTime(c.getExitThreadTime(), span, unit);
        String durationGlobal = TimeUtils.humanizeTime(
                c.getExitGlobalTime() - c.getEntryGlobalTime(), span, unit);
        String durationThread = TimeUtils.humanizeTime(
