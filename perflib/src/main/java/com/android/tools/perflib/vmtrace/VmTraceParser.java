...
public class VmTraceParser {
    ...
    private void parseMethodTraceData(MappedByteBuffer buffer, int recordSize) {
        ...
        while (buffer.hasRemaining()) {
            ...
            if (mTraceData.getVersion() == 1) {
                threadId = buffer.getInt();
            } else {
            ...
            switch (mTraceData.getClockType()) {
                case WALL:
                    threadTime = 0;
            ...
            mTraceData.addMethodAction(threadId, methodId, methodAction, threadTime, globalTime);
        }
    }
