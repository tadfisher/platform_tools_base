...
public class TraceViewCanvas extends JComponent {
    ...
    /** The time unit to use for all operations. */
    private static final TimeUnit sDefaultTimeUnit = TimeUnit.NANOSECONDS;
    ...
    public void displayThread(@NonNull String threadName) {
        ...
        mTimeScaleRenderer = new TimeScaleRenderer(
                mTopLevelCall.getEntryTime(ClockType.GLOBAL, sDefaultTimeUnit), sDefaultTimeUnit);
    ...
    private void zoomFit() {
        ...
        long start = mTopLevelCall.getEntryTime(ClockType.GLOBAL, sDefaultTimeUnit);
        long end = mTopLevelCall.getExitTime(ClockType.GLOBAL, sDefaultTimeUnit);
