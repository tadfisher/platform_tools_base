...
public class TraceViewCanvas extends JComponent {
    ...
    public void setTrace(VmTraceData traceData, String threadName) {
        mTraceData = traceData;
        displayThread(threadName);
    }

    public void displayThread(String threadName) {
        ...
        mTimeScaleRenderer = new TimeScaleRenderer(start);
        int height = mTimeScaleRenderer.getLayoutHeight();
        mCallHierarchyRenderer = new CallHierarchyRenderer(mTraceData, topLevelCall, start, height);
