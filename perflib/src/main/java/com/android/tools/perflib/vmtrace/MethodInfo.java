...
public class MethodInfo {
    ...
    public long getExclusiveTime(ThreadInfo thread, ClockType clockType) {
        long time = getExclusiveTime1(thread, clockType);
        assert time == mProfileData.getExclusiveTime(thread, clockType);
        return time;
    }

    private long getExclusiveTime1(ThreadInfo thread, ClockType clockType) {
