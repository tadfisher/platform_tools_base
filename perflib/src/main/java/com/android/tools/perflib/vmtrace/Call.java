...
public class Call {
    ...
    /**
     * Formats this call and all its call hierarchy using the given {@link MethodFormatter} to
     * print the details for each method.
     */
    public String format(MethodFormatter f) {
    ...
    public String toString() {
        return format(STRING_FORMATTER);
    }

    private void printCallHierarchy(@NonNull StringBuilder sb, MethodFormatter formatter) {
        sb.append(" -> ");
