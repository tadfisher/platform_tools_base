...
public class AllocationsParser {
  ...
  private static ByteBuffer mapFile(File f) throws IOException {
    ...
    try {
      ...
      ByteBuffer buff = buffer.asReadOnlyBuffer();
  ...
  */
  public void parse() throws IOException {
    ByteBuffer data = mapFile(myAllocationsFile);
