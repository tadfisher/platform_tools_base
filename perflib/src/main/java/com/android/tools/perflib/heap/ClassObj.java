...
public class ClassObj extends Instance implements Comparable<ClassObj> {
    ...
    public final void addInstance(@NonNull int heapId, @NonNull Instance instance) {
        mShalowSize += instance.getSize();
        ArrayList<Instance> targetList = mInstances.get(heapId);
        if (targetList == null) {
          targetList = new ArrayList<Instance>();
          mInstances.put(heapId, targetList);
        }
    ...
    public Instance[] getInstancesArray() {
