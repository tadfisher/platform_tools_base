...
/**
 * Non-recursive breadth-first visitor, managing its own stack.
 */
public class BreadthFirstVisitor implements Visitor {

    protected final Deque<Instance> mQueue = new ArrayDeque<Instance>();
    ...
    public void doVisit(Iterable<? extends Instance> startNodes) {
        ...
        while (!mQueue.isEmpty()) {
            Instance node = mQueue.pollFirst();
