...
import com.android.tools.perflib.heap.analysis.AlternateDominators;
...
public class Snapshot {
    ...
    public void computeAlternateDominators() {
        AlternateDominators dominators = new AlternateDominators(this);
