...
public class HprofOutputStream extends OutputStream {
   ...
   */
  public void writeU1(int data) throws IOException {
    mOutputStream.write(data & 0xFF);
  }

  public void writeU1(long data) throws IOException {
    writeU1((int)data);
  }
   ...
   */
  public void writeU2(int data) throws IOException {
    writeU1((data >> 8) & 0xFF);
    writeU1((data >> 0) & 0xFF);
  }

  public void writeU2(long data) throws IOException {
    writeU2((int)data);
  }
   ...
   */
  public void writeU4(long data) throws IOException {
    writeU1((data >> 24) & 0xFF);
    writeU1((data >> 16) & 0xFF);
    writeU1((data >>  8) & 0xFF);
    writeU1((data >>  0) & 0xFF);
  }
  ...
  public void writeU8(long data) throws IOException {
    writeU1((data >> 56) & 0xFF);
    writeU1((data >> 48) & 0xFF);
    writeU1((data >> 40) & 0xFF);
    writeU1((data >> 32) & 0xFF);
    writeU1((data >> 24) & 0xFF);
    writeU1((data >> 16) & 0xFF);
    writeU1((data >>  8) & 0xFF);
    writeU1((data >>  0) & 0xFF);
   ...
   */
  public void writeValue(short type, long data) throws IOException {
   ...
   */
  public void writeRecordHeader(int tag, long time, long length) throws IOException {
    writeU1(tag);
    writeU4(time);
    writeU4(length);
  }
  ...
  private void writeSized(int size, long data) throws IOException {
    switch (size) {
      case 1: writeU1(data); break;
      case 2: writeU2(data); break;
      case 4: writeU4(data); break;
