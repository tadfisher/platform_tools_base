...
public class HprofAllocSites implements HprofRecord {
  ...
  // Bit mask flags:
  public static final int INCREMENTAL_VS_COMPLETE = 0x1;
  public static final int SORTED_BY_ALLOCATION_VS_LINE = 0x2;
  public static final int FORCE_GC = 0x4;

  public final long time;
  public final int bitMaskFlags;              // u2
  public final long cutoffRatio;              // u4
  public final long totalLiveBytes;           // u4
  public final long totalLiveInstances;       // u4
  ...
  public HprofAllocSites(long time, int bitMaskFlags, long cutoffRatio,
      long totalLiveBytes, long totalLiveInstances, long totalBytesAllocated,
  ...
  public void write(HprofOutputStream hprof) throws IOException {
    hprof.writeRecordHeader(TAG, time, 2 + 4 + 4 + 4 + 8 + 8 + 4 + sites.length*HprofAllocSite.LENGTH);
