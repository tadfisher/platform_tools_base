...
public class VisitorsTest extends TestCase {
    ...
    public void testTopSortSimpleGraph() {
        ...
        assertEquals(snapshot.findReference(5), topSort.get(3));
        assertEquals(snapshot.findReference(4), topSort.get(4));
        assertEquals(snapshot.findReference(6), topSort.get(5));
    }
}
