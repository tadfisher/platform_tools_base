...
public class DominatorsTest extends TestCase {
    ...
    public void testSampleHprof() throws Exception {
        ...
        try {
            ...
            // A WeakReference object reachable via two GC roots, a JNI global and a Thread.
            Instance weakRef = snapshot.findReference(Long.parseLong("B0EDFFA0", 16));
            assertEquals(Snapshot.SENTINEL_ROOT, dominators.get(weakRef));
        } finally {
