...
public class HprofControlSettings implements HprofRecord {
  ...
  // Bit mask flags:
  public static final long ALLOC_TRACES_ON = 0x1;
  public static final long CPU_SAMPLING_ON = 0x2;

  public final long time;
  public final long bitMaskFlags;       // u4
  public final int stackTraceDepth;     // u2

  public HprofControlSettings(long time, long bitMaskFlags, int stackTraceDepth) {
    this.time = time;
