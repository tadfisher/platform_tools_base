...
public class Hprof {
   ...
   * @param isSize - The size of identifiers in bytes.
   * @param date - The date of the hprof dump.
   * @param records - The list of hprof records.
   */
  public Hprof(String format, int isSize, Date date, List<HprofRecord> records) {
    this.format = format;
    this.idSize = isSize;
    this.date = date;
  ...
  public void write(OutputStream os) throws IOException {
    ...
    hprof.writeU4(date.getTime() >> 32);
    hprof.writeU4(date.getTime() & 0xFFFFFFFF);
