...
public class HprofRootJniMonitor implements HprofDumpRecord {
  public static final short SUBTAG = 0x8e;

  public final long objectId;           // Id
  public final long threadSerialNumber; // u4
  public final long frameNumberInStackTrace; // u4

  public HprofRootJniMonitor(long objectId, long threadSerialNumber,
      long frameNumberInStackTrace) {
