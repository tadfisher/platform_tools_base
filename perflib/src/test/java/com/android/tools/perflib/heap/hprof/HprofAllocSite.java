...
public class HprofAllocSite {
  ...
  public final long numberOfLiveBytes;          // u4
  public final long numberOfLiveInstances;      // u4
  public final long numberOfBytesAllocated;     // u4
  public final long numberOfInstancesAllocated; // u4

  public HprofAllocSite(byte arrayIndicator, long classSerialNumber,
      long stackTraceSerialNumber, long numberOfLiveBytes,
      long numberOfLiveInstances, long numberOfBytesAllocated,
      long numberOfInstancesAllocated) {
