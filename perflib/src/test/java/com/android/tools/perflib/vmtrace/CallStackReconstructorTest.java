...
public class CallStackReconstructorTest extends TestCase {
    ...
    public void testCallDurations() {
        ...
        assertEquals(15 - 10 - (14 - 11), call.getExclusiveTime(ClockType.THREAD, TimeUnit.MICROSECONDS));
    }
    ...
    public void testMissingCallDurations() {
        ...
        assertEquals(15 - (11 - 1) - (14 - 11), call.getExclusiveTime(ClockType.THREAD, TimeUnit.MICROSECONDS));
    }
