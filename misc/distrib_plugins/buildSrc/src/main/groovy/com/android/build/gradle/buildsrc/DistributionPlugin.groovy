...
class DistributionPlugin implements org.gradle.api.Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        if (project.rootProject == project) {
            ...
            gatherNoticesTask.conventionMapping.distributionDir =  { project.file(extension.destinationPath + "/notices") }
            gatherNoticesTask.conventionMapping.repoDir =  { project.file(extension.dependenciesRepo) }
            ...
            buildTask.conventionMapping.destinationDir = { project.file(extension.destinationPath + "/tools/lib") }
            ...
            copyDependenciesTask.conventionMapping.distributionDir =  { project.file(extension.destinationPath + "/tools/lib") }
