...
public interface IDevice extends IShellEnabledDevice {
     ...
     * battery level if 5 minutes have expired since the last successful query.
     *
     * @return a {@link Future} that can be used to query the battery level. The Future may return
     * <code>null</code> if battery level could not be retrieved
     */
     ...
     * <p/>
     * The battery level may be cached. Only queries the device for its
     * battery level if <code>freshness</code> have expired since the last successful query.
     *
     * @param freshnessMs
     * @return a {@link Future} that can be used to query the battery level. The Future may return
     * <code>null</code> if battery level could not be retrieved
