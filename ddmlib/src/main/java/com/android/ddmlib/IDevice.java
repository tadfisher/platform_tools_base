...
public interface IDevice extends IShellEnabledDevice {
     ...
     *
     * @deprecated use {@link #getPropertyAsync(String)} instead
     */
    @Deprecated
    ...
    /**
     * Convenience method that attempts to retrieve a property via {@link #getPropertyAsync()}
     * with minimal wait time, and swallows exceptions.
     *
    ...
    /**
     * Do a potential asynchronous query for a system property. The property value may be cached, so
     * this should only be used for constant properties, typically named ro.*.
     *
     * @param name the name of the value to return.
     ...
     */
    public Future<String> getPropertyAsync(@NonNull String name);
