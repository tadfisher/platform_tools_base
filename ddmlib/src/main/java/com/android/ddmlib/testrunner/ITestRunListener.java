 ...
 * <p/>
 * Patterned after junit.runner.TestRunListener and org.junit.runner.notification.RunListener
 * <p/>
...
public interface ITestRunListener {
    ...
    /**
     * Called when a test failed due to unanticipated uncaught exception.
     * <p/>
     * Will be called between testStarted and testEnded.
     *
     * Note will only be called when using a JUnit3 based device test runner like
     * InstrumentationTestRunner. JUnit4 runners no longer have an error state.
     *
     * @param test identifies the test
