...
public class XmlTestRunListener implements ITestRunListener {
    ...
    public void testError(TestIdentifier test, String trace) {
        mRunResult.testError(test, trace);
    }
    ...
    void printTestResults(KXmlSerializer serializer, String timestamp, long elapsedTime)
        ...
        serializer.attribute(ns, ATTR_FAILURES, Integer.toString(
                mRunResult.getNumTestsInState(TestStatus.FAILURE) +
                mRunResult.getNumTestsInState(TestStatus.ASSUMPTION_FAILURE)));
        serializer.attribute(ns, ATTR_ERRORS, Integer.toString(mRunResult.getNumTestsInState(
                TestStatus.ERROR)));
    ...
    void print(KXmlSerializer serializer, TestIdentifier testId, TestResult testResult)
        ...
        switch (testResult.getStatus()) {
            ...
            case ASSUMPTION_FAILURE:
                ...
                break;
            case ERROR:
                printFailedTest(serializer, ERROR, testResult.getStackTrace());
                break;
            case IGNORED:
