...
public class LogCatReceiverTask implements Runnable {
    ...
    private final Set<ILogCatListener> mListeners = Collections.synchronizedSet(
            new HashSet<ILogCatListener>());
    ...
    public void addLogCatListener(ILogCatListener l) {
        mListeners.add(l);
    }

    public void removeLogCatListener(ILogCatListener l) {
        mListeners.remove(l);
    }

    private void notifyListeners(List<LogCatMessage> messages) {
