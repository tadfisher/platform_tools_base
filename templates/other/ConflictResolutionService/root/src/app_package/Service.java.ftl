...
import com.google.android.gms.cloudsave.EventService;
import com.google.android.gms.cloudsave.Entity;

public class ${className} extends EventService {
    ...
    protected Entity onConflict(Entity acceptedEntity, Entity newEntity, Entity ancestorEntity) {
        ...
        return executeMerge(newEntity, acceptedEntity, ancestorEntity);
    }
}
