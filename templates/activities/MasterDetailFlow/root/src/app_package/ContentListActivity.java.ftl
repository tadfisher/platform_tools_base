...
import <#if Support?has_content>android.support.v4.app.FragmentActivity<#else>android.app.Activity</#if>;
 ...
 */
public class ${CollectionName}Activity extends ${(Support?has_content)?string('Fragment','')}Activity
