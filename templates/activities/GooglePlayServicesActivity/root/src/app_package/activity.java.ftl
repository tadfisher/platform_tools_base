...
public class ${activityClass} extends Activity implements
    ...
    <#if includeCloudSave>
        ...
        // In the dialog, supply your email address and product name (the other fields in the dialog are optional) and click "Save".
        //
        // TODO 3: Start making API requests.
        //
        // Save an entity in CloudSave.
        // CloudSaveManager.save(mGoogleApiClient,
        //        Arrays.asList(new Entity(CloudSaveManager.generateEntityKey(mGoogleApiClient, "HelloWorldType", "HelloWorldInstance"))));
        //
        // Query for all entities of KIND "HelloWorldType".
        // CloudSaveManager.query(mGoogleApiClient, new Query.Builder().setKind("HelloWorldType").build())
        //   .setResultCallback(new ResultCallback<CloudSaveManager.QueryResult>() {
        //       @Override
        //       public void onResult(CloudSaveManager.QueryResult queryResult) {
        //           //process queryResult.getEntityList();
        //       }
        //   });
        //
        // If you need to add conflict resolution logic, add a CloudSave ConflictResolutionServce
    <#else>
