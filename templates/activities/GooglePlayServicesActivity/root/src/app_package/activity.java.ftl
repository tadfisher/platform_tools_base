...
public class ${activityClass} extends Activity implements
    ...
    <#if includeCloudSave>
        ...
        // Define a CloudSave entity.
        // if(entity == null) {
        //     entity = new Entity(CloudSaveManager.generateEntityKey(mGoogleApiClient, "HelloWorldType", "HelloWorldInstance");
        // }
        //
        // Save an entity in CloudSave.
        // CloudSaveManager.save(mGoogleApiClient, entity);
        //
