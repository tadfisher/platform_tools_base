...
public class SessionParams extends RenderParams {
    ...
    private final int mSimulatePlatformVersion;
     ...
     * @param targetSdkVersion the targetSdkVersion of the project
     * @param log the object responsible for displaying warning/errors to the user.
     * @param simulatePlatformVersion try to simulate an old android platform. 0 means disabled.
     */
    public SessionParams(
            ILayoutPullParser layoutDescription,
            RenderingMode renderingMode,
    ...
    public SessionParams(SessionParams params) {
        ...
        mSimulatePlatformVersion = params.mSimulatePlatformVersion;
