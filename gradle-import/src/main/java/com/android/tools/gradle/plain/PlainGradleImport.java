...
public class PlainGradleImport {
    ...
    /** Whether there is an existing project that we should try to merge into */
    private boolean myMergeExistingProject = false;
  ...
  public PlainGradleImport() {
    ...
    private void createSettingsGradle(@NonNull File file) throws IOException {
        ...
        Files.append(sb.toString(), file, UTF_8);
    }
  ...
  public void setMergeExistingProject(boolean mergeExistingProject) {
    myMergeExistingProject = mergeExistingProject;
  }

  public boolean isMergeExistingProject() {
    return myMergeExistingProject;
  }
