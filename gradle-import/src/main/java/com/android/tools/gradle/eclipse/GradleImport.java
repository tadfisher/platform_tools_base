...
public class GradleImport {
    ...
    public static final String CURRENT_BUILD_TOOLS_VERSION = "19.0.0";
    ...
    // To test local repositories for upcoming versions:
    //  ANDROID_GRADLE_PLUGIN = GRADLE_PLUGIN_NAME + GRADLE_PLUGIN_MINIMUM_VERSION + "-SNAPSHOT";
    //  MAVEN_REPOSITORY = "maven { url '/path/to/aosp/out/host/gradle/repo' }"
    ...
    public void exportProject(@NonNull File destDir, boolean allowNonEmpty) throws IOException {
        ...
        assert !needEclipseWorkspace() || mWorkspace != null;
    ...
    private static void createModuleBuildGradle(@NonNull File file, ImportModule module)
            throws IOException {
        ...
        if (module.isApp() || module.isAndroidLibrary()) {
            ...
            sb.append("    buildToolsVersion \"").append(CURRENT_BUILD_TOOLS_VERSION).append("\"")
                    .append(NL);
            sb.append("").append(NL);
    ...
    public void reportWarning(
        ...
        mSummary.reportWarning(module != null ? module.getOriginalName() : null, file, message);
    }
    ...
    public void reportWarning(
            ...
            @Nullable File file,
            @NonNull String message)  {
        mSummary.reportWarning(project != null ? project.getName() : null, file, message);
    }
