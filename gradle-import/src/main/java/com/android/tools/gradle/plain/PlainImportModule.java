...
class PlainImportModule extends PlainImportModuleBlah {
    private final PlainProject mProject;
    //private List<PlainImportModuleBlah> mDirectDependencies;
    //private List<PlainImportModuleBlah> mAllDependencies;

    public PlainImportModule(@NonNull PlainGradleImport importer, @NonNull PlainProject project) {
        super(importer);
        mProject = project;
    ...
    protected boolean dependsOnLibrary(@NonNull String pkg) {
        ...
        for (PlainProject project : mProject.getAllLibraries()) {
    ...
    //@NonNull
    //@Override
    //protected List<PlainImportModuleBlah> getDirectDependencies() {
    //    if (mDirectDependencies == null) {
    //        mDirectDependencies = Lists.newArrayList();
    //        for (PlainProject project : mProject.getDirectLibraries()) {
    //            PlainImportModule module = project.getModule();
    //            if (module != null) {
    ...
    //@NonNull
    //@Override
    //protected List<PlainImportModuleBlah> getAllDependencies() {
    ...
    @Override
    protected boolean dependsOn(@NonNull PlainImportModuleBlah other) {
        return mProject.getAllLibraries().contains(((PlainImportModule)other).mProject);
    }

    @NonNull
    public PlainProject getProject() {
        return mProject;
    }
