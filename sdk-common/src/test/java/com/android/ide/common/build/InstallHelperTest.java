...
public class InstallHelperTest extends TestCase {
     ...
     */
    private static FilteredOutput computeMatchingOutput(
            @NonNull List<? extends FilteredOutput> outputs,
            int density,
            @NonNull String... abis) {
        return InstallHelper.computeMatchingOutput(outputs, density, Arrays.asList(abis));
    }

    /**
     * Fake implementation of FilteredOutput
     */
    private static final class FakeFilteredOutput implements FilteredOutput {

        private final String densityFilter;
        private final String abiFilter;

        FakeFilteredOutput(String densityFilter, String abiFilter) {
    ...
    public void testSingleOutput() {
        ...
        FilteredOutput result = computeMatchingOutput(list, 160, "foo");
    ...
    public void testAbiOnlyWithMultiMatch() {
        ...
        FilteredOutput result = computeMatchingOutput(list, 160, "bar", "foo");
    ...
    public void testAbiOnlyWithUniversalMatch() {
        ...
        FilteredOutput result = computeMatchingOutput(list, 160, "zzz");
