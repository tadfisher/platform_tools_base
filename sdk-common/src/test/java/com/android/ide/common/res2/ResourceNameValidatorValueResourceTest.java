...
public class ResourceNameValidatorValueResourceTest {
    ...
    public static Collection<Object[]> expected() {
        return Arrays.asList(new Object[][] {
                ...
                { "void", ResourceType.STRING, null, "void is not a valid name (reserved Java keyword)"},
        });
    }
    ...
    public void validate() {
        ...
        try {
            ResourceNameValidator.validate(mResourceName, mResourceType, mSourceFile);
        } catch (MergingException e) {
            errorMessage = e.getMessage();
        }
        ResourceNameValidatorFileResourceTest.assertErrorMessageCorrect(
