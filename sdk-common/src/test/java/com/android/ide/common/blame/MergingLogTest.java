...
public class MergingLogTest {
    ...
    public void testMergingLog() {
        ...
        mergingLog.logCopy(new File("exploded/layout/a"), new File("merged/layout/a"));
        mergingLog.logCopy(new File("exploded/layout-land/a"), new File("merged/layout-land/a"));
        ...
        mergingLog.logSource(new SourceFile(new File("merged/values/values.xml")), map);
        ...
        mergingLog.logSource(new SourceFile(new File("merged/values-de/values.xml")), map2);

        // Write and then reload (won't load anything immediately).
        mergingLog.write();
        mergingLog = new MergingLog(tempDir);

        mergingLog.logRemove(new SourceFile(new File("merged/layout/a")));
        ...
        Assert.assertEquals("", new SourceFile(new File("exploded/layout-land/a")),
                mergingLog.find(new SourceFile(new File("merged/layout-land/a"))));
