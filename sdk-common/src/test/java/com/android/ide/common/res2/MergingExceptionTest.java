    ...
    public void testGetMessage() {
        ...
        assertEquals("/some/random/path: Error: My error message",
                MergingException.wrapException(new Exception("My error message")).withFile(file)
                        .build().getMessage());
        MergingException.MergingExceptionBuilder mergingExceptionBuilder2 = MergingException.wrapException(new Exception("My error message")).withFile(file)
                .withPosition(new SourcePosition(49, -1, -1));
        assertEquals("/some/random/path:50: Error: My error message",
                mergingExceptionBuilder2.build()
                        .getMessage());
        MergingException.MergingExceptionBuilder mergingExceptionBuilder1 = MergingException.wrapException(new Exception("My error message")).withFile(file)
                .withPosition(new SourcePosition(49, 3, -1));
        assertEquals("/some/random/path:50:4: Error: My error message",
                mergingExceptionBuilder1.build()
                        .getMessage());
        MergingException.MergingExceptionBuilder mergingExceptionBuilder = MergingException.wrapException(new Exception("My error message")).withFile(file)
                .withPosition(new SourcePosition(49, 3, -1));
        assertEquals("/some/random/path:50:4: Error: My error message",
                mergingExceptionBuilder.build()
                        .getLocalizedMessage());
        assertEquals("/some/random/path: Error: My error message",
