...
public abstract class ResourceVisibilityLookup {
    ...
    private static final ResourceVisibilityLookup EMPTY = new ResourceVisibilityLookup() {
        @Override
    ...
    public static class Provider {
        ...
        public ResourceVisibilityLookup get(@NonNull AndroidArtifact artifact) {
            ...
            if (visibility == null) {
                ...
                visibility = list.isEmpty() ? EMPTY : new MultipleLibraryResourceVisibility(list);
        ...
        public ResourceVisibilityLookup get(
            ...
            if (visibility == null) {
                // getPublicResources() was introduced in model version 3
                //if (project.getApiVersion() < 3) {
                if (!project.getModelVersion().startsWith("1.3.")) {
                    visibility = EMPTY;
                } else {
