...
public abstract class ResourceVisibilityLookup {
    ...
    public static class Provider {
        private Map<AndroidLibrary,ResourceVisibilityLookup> mLibraryMap = Maps.newHashMap();
        private Map<AndroidArtifact,ResourceVisibilityLookup> mArtifactMap = Maps.newHashMap();
        ...
        public ResourceVisibilityLookup get(@NonNull AndroidLibrary library) {
            ResourceVisibilityLookup visibility = mLibraryMap.get(library);
            if (visibility == null) {
                ...
                mLibraryMap.put(library, visibility);
            }
            return visibility;
        }
        ...
        public ResourceVisibilityLookup get(@NonNull AndroidArtifact artifact) {
            ResourceVisibilityLookup visibility = mArtifactMap.get(artifact);
            if (visibility == null) {
                ...
                visibility = new MultipleLibraryResourceVisibility(list);
                mArtifactMap.put(artifact, visibility);
            }
            return visibility;
        }
    }
