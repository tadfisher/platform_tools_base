...
public class GradleCoordinate implements Comparable<GradleCoordinate> {
  ...
  public static GradleCoordinate parseCoordinateString(@NonNull String coordinateString) {
    ...
    if (revision.equals("+")) {
      ...
      try {
        String majorRevisionString = matcher.group(1);
        majorRevision = (majorRevisionString.equals("+")) ? PLUS_REV : Integer.parseInt(majorRevisionString);
        String minorRevisionString = matcher.group(2);
        minorRevision = (majorRevisionString.equals("+")) ? PLUS_REV : Integer.parseInt(minorRevisionString);
        String microRevisionString = matcher.group(3);
        microRevision = (microRevisionString.equals("+")) ? PLUS_REV : Integer.parseInt(microRevisionString);
