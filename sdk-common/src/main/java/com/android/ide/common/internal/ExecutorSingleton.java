...
public class ExecutorSingleton {
     ...
     *
     * @param sThreadPoolSize the number of threads to use.
     */
    public static void setThreadPoolSize(int sThreadPoolSize) {
        ExecutorSingleton.sThreadPoolSize = sThreadPoolSize;
    }
}
