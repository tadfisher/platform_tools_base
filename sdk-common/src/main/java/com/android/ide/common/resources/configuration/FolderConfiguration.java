...
public final class FolderConfiguration implements Comparable<FolderConfiguration> {
  ...
  /**
    ...
    public List<Configurable> findMatchingConfigurables(
        ...
        if (matchingConfigurables.size() == 1 || matchingConfigurables.isEmpty()) {
        ...
        for (int q = 0 ; q < count ; q++) {
            ...
            // "best" match.
            if (found && referenceQualifier != null && referenceQualifier.isValid()) {
                for (int i = 0 ; i < matchingConfigurables.size(); ) {
                    ...
                    if (qualifier == null) {
                        ...
                        // there is a better match for the reference qualifier than
