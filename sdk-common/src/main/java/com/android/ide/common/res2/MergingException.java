...
public class MergingException extends Exception {
    ...
    public static class MergingExceptionBuilder {
        ...
        private MergingExceptionBuilder() {
        }

        public MergingExceptionBuilder wrapException(Throwable cause) {
            mCause = cause;
            return this;
        }

        public MergingExceptionBuilder withFile(File file) {
            mFile = new SourceFile(file);
            return this;
        }

        public MergingExceptionBuilder withFile(SourceFile file) {
            mFile = file;
            return this;
        }

        public MergingExceptionBuilder withPosition(SourcePosition position) {
            mPosition = position;
            return this;
        }

        public MergingExceptionBuilder withMessage(String messageText, Object... args) {
    ...
    public static MergingExceptionBuilder wrapException(@NonNull Throwable cause) {
        return new MergingExceptionBuilder().wrapException(cause);
    }

    public static MergingExceptionBuilder withMessage(@Nullable String message, Object... args) {
        return new MergingExceptionBuilder().withMessage(message, args);
    }
