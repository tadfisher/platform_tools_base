...
public class PackagingUtils {
    ...
    private static boolean isOfNonResourcesExtensions(String extension) {
        for (String ext : getNonResourcesExtensions()) {
    ...
    private static boolean isNotAResourceFile(String fileName) {
        for (String name : getNonResourcesFileNames()) {
     ...
     */
    public static ImmutableList<String> getNonResourcesExtensions() {
     ...
     */
    public static ImmutableList<String> getNonResourcesFileNames() {
        return ImmutableList.<String>builder()
                .add("license.txt")     // license file
