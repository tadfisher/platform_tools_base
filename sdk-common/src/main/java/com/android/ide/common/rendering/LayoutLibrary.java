...
public class LayoutLibrary {
     ...
     * @return {@link Bridge.LAYOUT_LTR} or {@link Bridge.LAYOUT_RTL} depending on the locale.
     */
    public int getLocaleCharacterOrientation(String locale) {
        return supports(Capability.RTL) ?
                mBridge.getLocaleCharacterOrientation(locale) : Bridge.LAYOUT_LTR;
    }
