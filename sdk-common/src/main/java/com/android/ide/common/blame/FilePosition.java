...
public class FilePosition extends SourcePositionRange {

    private final File sourceFile;

    public FilePosition(@NonNull File sourceFile, @NonNull SourcePositionRange position) {
        super(position);
    ...
    public boolean equals(Object obj) {
        ...
        return other.getSourceFile().getAbsolutePath() == getSourceFile().getAbsolutePath() &&
                super.equals((SourcePositionRange) other);
