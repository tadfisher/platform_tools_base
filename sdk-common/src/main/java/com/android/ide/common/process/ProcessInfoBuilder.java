...
public class ProcessInfoBuilder extends ProcessEnvBuilder<ProcessInfoBuilder> {
    ...
    public ProcessInfo createProcess() {
        if (mExecutable == null) {
            throw new IllegalStateException("executable is missing");
        }
    ...
    public JavaProcessInfo createJavaProcess() {
        if (mClasspath == null) {
            throw new IllegalStateException("classpath is missing");
        }

        if (mMain == null) {
            throw new IllegalStateException("main class is missing");
        }
     ...
     */
    @NonNull
    public ProcessInfoBuilder addArg(@NonNull String arg) {
        mArgs.add(arg);
        return this;
    }
