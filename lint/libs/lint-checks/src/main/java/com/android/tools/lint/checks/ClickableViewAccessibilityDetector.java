...
public class ClickableViewAccessibilityDetector extends Detector implements Detector.ClassScanner {
    ...
    public static final Issue ISSUE = Issue.create(
            ...
            "Views overriding onTouchEvent should also implement performClick and call performClick"
                    + " when clicks occur",
            "Checks that custom views handle accessibility on click events",
            "If a View that overrides onTouchEvent does not also implement performClick and call"
                    + " it, the View may not handle accessibility actions properly.",
            Category.A11Y,
            6,
            Severity.WARNING,
            new Implementation(
    ...
    public void checkClass(@NonNull ClassContext context, @NonNull ClassNode classNode) {
        ...
        MethodNode onTouchEvent = getMethod(classNode.methods, ON_TOUCH_EVENT, ON_TOUCH_EVENT_SIG);
        MethodNode performClick = getMethod(classNode.methods, PERFORM_CLICK, PERFORM_CLICK_SIG);
        ...
        if (onTouchEvent != null) {
            ...
            if (performClick == null) {
                ...
                AbstractInsnNode performClickInOnTouchEventInsnNode = getMethodCallInstruction(
        ...
        if (performClick != null) {
            AbstractInsnNode superPerformClickInPerformClickInsnNode = getMethodCallInstruction(
    ...
    @Nullable
    private AbstractInsnNode getMethodCallInstruction(
