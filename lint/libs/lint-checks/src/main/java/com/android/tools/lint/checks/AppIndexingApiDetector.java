    ...
    public void visitElement(@NonNull XmlContext context, @NonNull Element activity) {
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (child.getNodeType() == Node.ELEMENT_NODE &&
                ...
                for (int j = 0; j < intentChildren.getLength(); j++) {
                    ...
                    if (intentChild.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        if (e.getNodeName().equals(NODE_DATA)) {
                            ...
                            // If this activity is an action view, is browsable, but neither has a
                            // URL nor mimeType, it may be a mistake and report warning.
                ...
                // If this activity is an action view, is browsable, but missing data node, it may
                // be a mistake and report warning.
