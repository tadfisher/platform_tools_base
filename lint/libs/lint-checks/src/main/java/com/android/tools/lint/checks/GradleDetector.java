...
public class GradleDetector extends Detector implements Detector.GradleScanner {
    ...
    private static final String LIB_PLUGIN_ID = "com.android.library";
    private static final String OLD_APP_PLUGIN_ID = "android";
    private static final String OLD_LIB_PLUGIN_ID = "android-library";
