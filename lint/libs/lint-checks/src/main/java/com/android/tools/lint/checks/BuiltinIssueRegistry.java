...
public class BuiltinIssueRegistry extends IssueRegistry {
    ...
    static {
        ...
        issues.add(WearDetector.WEAR_APP_DEPRECATED_WATCH_FACE_ISSUE);
        issues.add(WearDetector.WEAR_APP_WATCH_FACE_MISSING_PERMISSIONS_ISSUE);
        issues.add(WearDetector.WEAR_APP_WATCH_FACE_MISSING_SERVICE_ISSUE);
