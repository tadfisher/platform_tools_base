...
public class SecurityDetectorTest extends AbstractCheckTest {
    ...
    public void testWorldWriteable() throws Exception {
        assertEquals(
            "src/test/pkg/WorldWriteableFile.java:41: Warning: Setting file permissions to world-readable is very dangerous [SetWorldReadable]\n" +
            "            mFile.setReadable(true, false);\n" +
            "            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n" +
            "src/test/pkg/WorldWriteableFile.java:48: Warning: Setting file permissions to world-writable is very dangerous [SetWorldWritable]\n" +
