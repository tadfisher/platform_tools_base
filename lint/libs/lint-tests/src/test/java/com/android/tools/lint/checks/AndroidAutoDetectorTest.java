...
public class AndroidAutoDetectorTest extends AbstractCheckTest {
    ...
    // TODO: These stubs are necessary for JavaContext.resolve(node)
    // See if these can be worked around.
    private final TestFile mStringClassStub = java("src/java/lang/String.java", ""
            + "package java.lang;\n"
            + "public final class String {\n"
            + "}\n");

    private final TestFile mBundleClassStub = java("src/java/lang/Bundle.java", ""
            + "package android.os;\n"
            + "public class Bundle {\n"
            + "}\n");
