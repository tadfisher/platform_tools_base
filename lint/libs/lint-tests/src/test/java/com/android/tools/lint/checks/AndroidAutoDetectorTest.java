...
public class AndroidAutoDetectorTest extends AbstractCheckTest {
    ...
    private final SdkTestCase.TestFile mMediaSessionStub =
            java("src/android/media/session/MediaSession.java", "" +
    ...
    public void testMissingIntentFilter() throws Exception {
        ...
        String expected = "AndroidManifest.xml: Error: Missing intent-filter for action android.media.browse.MediaBrowserService that is required for android auto support [MissingMediaBrowserServiceIntentFilter]\n"
                + "1 errors, 0 warnings\n";
    ...
    public void testInvalidAutoMetadataPlacement() throws Exception {
        mEnabled = Collections.singleton(
                AndroidAutoDetector.INVALID_AUTO_METADATA_ISSUE);
        String expected = "AndroidManifest.xml:6: Error: <meta-data> tag must appear as a child of the <application> tag. [InvalidAutoMetadata]\n"
                + "    <meta-data\n"
                + "    ^\n"
                + "1 errors, 0 warnings\n";
        String result = lintProject(
    ...
    public void testMissingMediaSearchIntent() throws Exception {
        ...
        String expected = "AndroidManifest.xml: Error: Missing intent-filter for action android.media.action.MEDIA_PLAY_FROM_SEARCH. [MissingIntentFilterForMediaSearch]\n"
                + "1 errors, 0 warnings\n";
