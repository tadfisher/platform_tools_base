...
public class AppIndexingApiDetectorTest extends AbstractCheckTest {
    ...
    public void testCheckDataNode() throws Exception {
        assertEquals(""
                        + "AndroidManifest.xml:28: Error: android:host missing [AppIndexingError]\n"
                        ...
                        + "                <data android:pathPrefix=\"gizmos\" />\n"
                        + "                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "AndroidManifest.xml:28: Error: android:scheme missing [AppIndexingError]\n"
                        + "                <data android:pathPrefix=\"gizmos\" />\n"
                        + "                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "AndroidManifest.xml:28: Warning: android:scheme should be set for the intent filter [AppIndexingWarning]\n"
                        + "                <data android:pathPrefix=\"gizmos\" />\n"
                        + "                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "3 errors, 1 warnings\n",
                lintProject(xml("AndroidManifest.xml", ""
