...
public class AppIndexingApiDetectorTest extends AbstractCheckTest {
    ...
    public void testWrongPathPrefix() throws Exception {
        assertEquals(""
                        + "AndroidManifest.xml:19: Error: android:pathPrefix attribute should start with / [AppIndexingError]\n"
                        + "                    android:pathPrefix=\"gizmos\" />\n"
                        + "                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "1 errors, 0 warnings\n",
                lintProject(xml("AndroidManifest.xml", ""
        ...
        assertEquals("No warnings.",
                lintProject(xml("AndroidManifest.xml", ""
                        ...
                        xml("res/values/strings.xml", ""
                                + "<resources>\n"
                                + "    <string name=\"path_prefix\">/gizmos</string>\n"
                                + "    <string name=\"port\">8080</string>\n"
                                + "</resources>\n")));
    }

    public void testMissingSlashWithResource() throws Exception {
        assertEquals("AndroidManifest.xml:19: Error: android:pathPrefix attribute should start with / [AppIndexingError]\n"
                        + "                    android:pathPrefix=\"@string/path_prefix\" />\n"
                        + "                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "1 errors, 0 warnings\n",
                lintProject(xml("AndroidManifest.xml", ""
    ...
    public void testWrongPortWithResource() throws Exception {
        assertEquals("AndroidManifest.xml:20: Error: android:port is not a legal number [AppIndexingError]\n"
                        + "                    android:port=\"@string/port\"/>\n"
                        + "                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                        + "1 errors, 0 warnings\n",
                lintProject(xml("AndroidManifest.xml", ""
