...
public class ManifestOrderDetectorTest extends AbstractCheckTest {
    ...
    public void testDeviceAdmin() throws Exception {
        ...
        assertEquals(""
                ...
                + "                       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                + "AndroidManifest.xml:44: Warning: You must add android.app.action.DEVICE_ADMIN_ENABLED as an intent filter action [DeviceAdmin]\n"
                + "            <meta-data android:name=\"android.app.device_admin\"\n"
                + "                       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                + "AndroidManifest.xml:56: Warning: You must add android.app.action.DEVICE_ADMIN_ENABLED as an intent filter action [DeviceAdmin]\n"
                + "            <meta-data android:name=\"android.app.device_admin\"\n"
                + "                       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                + "0 errors, 3 warnings\n",
