...
public class LintCliXmlParser extends XmlParser {
    ...
    public Location getNameLocation(@NonNull XmlContext context, @NonNull Node node) {
        ...
        int startOffset = start.getStartOffset() + delta;
        int startColumn = start.getStartColumn() + delta;
        return Location.create(location.getFile(),
                new DefaultPosition(start.getStartLine(), startColumn, startOffset),
                new DefaultPosition(end.getStartLine(), startColumn + length, startOffset + length));
    }
    ...
    public Location getValueLocation(@NonNull XmlContext context, @NonNull Attr node) {
        ...
        int totalLength = end.getStartOffset() - start.getStartOffset();
