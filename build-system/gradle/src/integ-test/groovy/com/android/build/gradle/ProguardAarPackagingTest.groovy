...
class ProguardAarPackagingTest {
    ...
    private static String JAVA_SOURCE = """\
            ...
            """.stripIndent()
    private static String PROGUARD_OPTIONS = """\
    ...
    static public void setup() {
                ...
                android {
                    ...
                    buildTypes {
                        release {
                            ...
                            proguardFile 'proguard-dontwarn.cfg'
                        }
                    }
                }
        ...
        // Overwrite existing HelloWorld file to use the library method
        // so proguard doesn't remove it.
        File javaSource = new File(fixture.getSourceDir(),
                "main/java/com/example/helloworld/HelloWorld.java")
        javaSource.write(JAVA_SOURCE)

        // proguard options file
        fixture.file("proguard-dontwarn.cfg") << PROGUARD_OPTIONS
