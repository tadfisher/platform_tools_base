...
public class ExtraModelInfo {
    ...
    private static ModelQueryMode computeModelQueryMode(@NonNull Project project) {
        if (hasTrueProperty(project, PROPERTY_BUILD_MODEL_ONLY_ADVANCED)) {
            return ModelQueryMode.IDE_ADVANCED;
        }

        if (hasTrueProperty(project, PROPERTY_BUILD_MODEL_ONLY)) {
    ...
    private static boolean hasTrueProperty(
