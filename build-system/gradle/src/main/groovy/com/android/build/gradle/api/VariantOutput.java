...
public abstract class VariantOutput {
    ...
    public static ImmutableList<SplitVariantOutput> load(File inputFile)
            throws FileNotFoundException {

        GsonBuilder gsonBuilder = new GsonBuilder();
        gsonBuilder.registerTypeAdapter(SplitVariantOutput.class,
                new VariantOutput.SplitVariantOutput.JsonDeserializer());
        Gson gson = gsonBuilder.create();

        ImmutableList.Builder<SplitVariantOutput> builder = ImmutableList.builder();

        for (SplitVariantOutput vo : gson.fromJson(new FileReader(inputFile),
