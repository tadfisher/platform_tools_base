...
class ProductFlavorDsl extends DefaultProductFlavor {
    ...
    public ProductFlavor setPackageName(String packageName) {
        logger.warn("WARNING: packageName is deprecated; change to \"applicationId\" instead");
    ...
    public String getTestPackageName() {
        logger.warn("WARNING: testPackageName is deprecated; change to \"testApplicationId\" instead");
