...
public class VariantFilterImpl implements VariantFilter {
    ...
    public VariantFilterImpl(@NonNull ImmutableObjectProvider immutableObjectProvider) {
    ...
    public ProductFlavor getDefaultConfig() {
        return immutableObjectProvider.getDefaultConfig(defaultConfig);
    }

    @Override
    @NonNull
    public BuildType getBuildType() {
        return immutableObjectProvider.getBuildType(buildType);
    }
    ...
    public List<GroupableProductFlavor> getFlavors() {
        return flavors != null ?
                new ImmutableFlavorList(flavors, immutableObjectProvider) :
