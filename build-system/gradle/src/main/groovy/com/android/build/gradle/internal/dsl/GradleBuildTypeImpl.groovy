 ...
 */
public class GradleBuildTypeImpl extends DefaultBuildType implements GradleBuildType, Serializable {
    ...
    public GradleBuildTypeImpl(@NonNull String name,
    ...
    @VisibleForTesting
    GradleBuildTypeImpl(@NonNull String name,
                 @NonNull Project project,
                 @NonNull Logger logger) {
        super(name)
        this.project = project
