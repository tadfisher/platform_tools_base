...
public class AndroidComponentModelSourceSet
    ...
    FunctionalSourceSet androidSources;
                        ...
                        new Action<LanguageSourceSet>() {
                            ...
                            public void execute(LanguageSourceSet languageSourceSet) {
                                ...
                                if (source.getSrcDirs().isEmpty()) {
                                    //String dirName = languageSourceSet.getName().startsWith(functionalSourceSet.getName()) ?
                                    //        languageSourceSet.getName().substring(functionalSourceSet.getName().length()) :
                                    //        languageSourceSet.getName();
                                    //source.srcDir("src/" + functionalSourceSet.getName() + "/" + dirName);
