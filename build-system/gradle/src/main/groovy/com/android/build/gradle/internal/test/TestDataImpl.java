...
public class TestDataImpl implements TestData {
    ...
    public File getTestedApk(int density, @NonNull List<String> abis) {
        ...
        ImmutableList.Builder<OutputFile> mainApks = ImmutableList.builder();
        for (BaseVariantOutputData baseVariantOutputData : testedVariantData2.getOutputs()) {
            mainApks.add(baseVariantOutputData.getMainOutputFile());
        }
