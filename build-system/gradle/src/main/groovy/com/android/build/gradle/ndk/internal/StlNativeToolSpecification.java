...
/**
 * Created by chiur on 6/4/14.
 */
public class StlNativeToolSpecification extends AbstractNativeToolSpecification {
//    private static final String STLPORT_STATIC = "stlport_static";
    ...
    public File getStlLib() {
        String stlLib;
        if (stl.equals("stlport_static")) {
            stlLib = "stlport";
        } else if (stl.equals("stlport_shared")) {
            stlLib = "stlport";
        } else if (stl.equals("gnustl_static")) {
            stlLib = "gnu-libstdc++/4.8";
        } else if (stl.equals("gnustl_shared")) {
            stlLib = "gnu-libstdc++/4.8";
        } else if (stl.equals("gabi++_static") || stl.equals("gabi++_shared")) {
            stlLib = "gabi++";
        } else if (stl.equals("c++_static") || stl.equals("c++_shared")) {
