...
/**
 * Immutable version of the GroupableProductFlavor wrapping another GroupableProductFlavor.
 *
 ...
 */
public class ImmutableGroupableProductFlavor extends ImmutableProductFlavor implements
        GroupableProductFlavor {

    ImmutableGroupableProductFlavor(
            @NonNull GroupableProductFlavor productFlavor,
            @NonNull ImmutableObjectProvider immutableObjectProvider) {
        super(productFlavor, immutableObjectProvider);
    }
