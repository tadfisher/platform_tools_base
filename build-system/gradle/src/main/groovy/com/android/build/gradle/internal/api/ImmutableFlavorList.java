...
/**
 * Implementation of List that create immutable GroupableProductFlavor on the fly as they are
 * queried. The list itself is also immutable.
 */
public class ImmutableFlavorList implements List<GroupableProductFlavor> {
    ...
    public int indexOf(Object o) {
        if (o instanceof ImmutableProductFlavor) {
            return list.indexOf(((ImmutableProductFlavor) o).productFlavor);
        }
    ...
    public int lastIndexOf(Object o) {
        if (o instanceof ImmutableProductFlavor) {
            return list.lastIndexOf(((ImmutableProductFlavor) o).productFlavor);
        }
