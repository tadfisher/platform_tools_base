...
public class ProductFlavorData<T extends DefaultProductFlavor> {
    ...
    DefaultAndroidSourceSet getTestSourceSet(VariantConfiguration.Type type) {
        switch (type) {
    ...
    ConfigurationProvider getTestConfigurationProvider(VariantConfiguration.Type type) {
        switch (type) {
            case VariantConfiguration.Type.ANDROID_TEST:
