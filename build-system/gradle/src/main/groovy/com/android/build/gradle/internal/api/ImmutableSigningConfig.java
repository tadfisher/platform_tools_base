...
/**
 * Immutable version of the SigningConfig wrapping another SigningConfig.
 *
 ...
 */
public class ImmutableSigningConfig implements SigningConfig {

    @NonNull
    private final SigningConfig signingConfig;

    ImmutableSigningConfig(@NonNull SigningConfig signingConfig) {
