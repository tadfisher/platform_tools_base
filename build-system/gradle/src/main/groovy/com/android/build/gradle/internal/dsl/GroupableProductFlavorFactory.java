 ...
 * the DSL methods.
 */
public class GroupableProductFlavorFactory implements NamedDomainObjectFactory<GradleGroupableProductFlavor> {
    ...
    @Override
    public GradleGroupableProductFlavor create(String name) {
