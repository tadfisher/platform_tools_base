...
/**
 * Created by xav on 4/21/14.
 */
class JacocoTask extends DefaultTask {
    ...
    void instrument() {
        ...
        getAnt().instrumentWithJacoco(destdir: getOutputDir()) {
            fileset(dir: getInputDir())
        }
//        excludes: "**/R.class,**/R*.class,**/BuildConfig.class,**/Manifest.class,**/Manifest*.class")
    }
}
