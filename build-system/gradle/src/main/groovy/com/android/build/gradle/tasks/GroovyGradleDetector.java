...
public class GroovyGradleDetector extends GradleDetector {
                                ...
                                for (Statement statement : bs.getStatements()) {
                                    if (statement instanceof ExpressionStatement) {
                                        ...
                                        if (e.getExpression() instanceof MethodCallExpression) {
                                            MethodCallExpression c = (MethodCallExpression)e.getExpression();
    ...
    protected Location createLocation(@NonNull Context context, @NonNull Object cookie) {
        ...
        return Location.create(context.file,
                new DefaultPosition(node.getLineNumber() - 1, node.getColumnNumber() - 1, offsets.getFirst()),
                new DefaultPosition(node.getLastLineNumber() - 1, node.getLastColumnNumber() - 1, offsets.getSecond()));
    }
}