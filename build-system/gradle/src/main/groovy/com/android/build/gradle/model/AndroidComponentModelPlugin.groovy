...
public class AndroidComponentModelPlugin implements Plugin<Project> {
    ...
    static class Rules {
        ...
        @Model
        List<ProductFlavorCombo> createProductFlavorCombo (NamedDomainObjectContainer<GroupableProductFlavorDsl> productFlavors) {
            ...
            return  ProductFlavorCombo.createGroupList(flavorDimensionList, productFlavors);
        }
        ...
        void createBinaries(
            ...
            if (flavorGroups.isEmpty()) {
                flavorGroups.add(new ProductFlavorCombo());
            }
    ...
    private static String getBinaryName(BuildType buildType, ProductFlavorCombo flavorGroup) {
