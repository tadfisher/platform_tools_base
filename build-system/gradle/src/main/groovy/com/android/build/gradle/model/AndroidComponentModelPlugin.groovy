...
public class AndroidComponentModelPlugin implements Plugin<Project> {
    ...
    static class Rules {
        ...
        AndroidComponentModelSourceSet createAndroidSourceSet (ServiceRegistry serviceRegistry, ProjectSourceSet projectSourceSet) {
            ...
            println "createAndroidSourceSet"
        ...
        private static class LanguageSourceSetFactoryBuilder<U> {
            public static NamedDomainObjectFactory<U> createFactory(
                ...
                return new NamedDomainObjectFactory() {
                    public U create(String name) {
                        return (U) instantiator.
                                newInstance(implementation, name, parentName,
                                        fileResolver);
                    }
                }
            }
