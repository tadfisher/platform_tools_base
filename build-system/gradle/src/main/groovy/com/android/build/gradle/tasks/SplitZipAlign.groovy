...
class SplitZipAlign extends DefaultTask implements OutputFileTask{
    ...
    @TaskAction
    void splitZipAlign() {
        println "In zip ALIGN"
        ImmutableList<VariantOutput.SplitVariantOutput> splitVariantOutputs = VariantOutput.load(getPackagedSplitResListFile());

        ImmutableCollection.Builder<VariantOutput> tmpOutputs =
                ImmutableList.builder();
        for (VariantOutput.SplitVariantOutput splitVariantOutput : splitVariantOutputs) {
