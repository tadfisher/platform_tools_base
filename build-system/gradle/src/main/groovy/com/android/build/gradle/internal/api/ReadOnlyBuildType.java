 ...
 * type (which all contains only getters), the dynamics of Groovy makes it easy to
...
public class ReadOnlyBuildType extends ReadOnlyBaseConfig implements BuildType {
    ...
    public ReadOnlyBuildType(@NonNull BuildType buildType) {
        super(buildType);
