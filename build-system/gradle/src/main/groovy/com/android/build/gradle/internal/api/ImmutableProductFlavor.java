...
/**
 * Read-only version of the ProductFlavor.
 *
 ...
 */
public class ImmutableProductFlavor extends ReadOnlyBaseConfig implements ProductFlavor {

    @NonNull
    /*package*/ final ProductFlavor productFlavor;

    public ImmutableProductFlavor(@NonNull ProductFlavor productFlavor) {
        super(productFlavor);
    ...
    public SigningConfig getSigningConfig() {
        return productFlavor.getSigningConfig();
    }
}
