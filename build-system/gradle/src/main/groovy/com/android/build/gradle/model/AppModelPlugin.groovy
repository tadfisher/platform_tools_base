...
public class AppModelPlugin extends BasePlugin implements Plugin<Project> {
    ...
    static class Rules {
        ...
        @Model
        VariantManager createVariantManager(BasePlugin plugin) {
                //AppExtension extension) {
            // FIXME: AppExtension should part of the input, but the createAndroidComponents rule
            // doesn't get activated if I do that.  This seems to be a rule dependency issue where
            // depending on SpecContainer does not depend on CollectionBuilder<AndroidComponentSpec>
            // I think this would be solve with @ComponentBinaries annotations.
        ...
        void createAndroidComponents(
                ...
                BasePlugin plugin) {
            androidComponents.create("android") { DefaultAndroidComponentSpec spec ->
        ...
        @Mutate
        void createReportTasks(TaskContainer tasks, VariantManager variantManager) {
        ...
        @Mutate
        void createLifeCycleTasks(TaskContainer tasks, BasePlugin plugin) {
        ...
        // Must be run after createLifeCycleTasks.
        @Finalize
        ...
        @Mutate
        void applySourceSetsToProductFlavors(
                VariantManager variantManager,
