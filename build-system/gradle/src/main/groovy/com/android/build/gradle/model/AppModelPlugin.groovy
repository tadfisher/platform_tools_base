...
public class AppModelPlugin extends BasePlugin implements Plugin<Project> {
    ...
    static class Rules {
        ...
        VariantManager createVariantManager() {
            ...
            // doesn't get activated if I do that.  It seems that I need to wait for
            // @ComponentBinaries to be implemented.
        ...
        @Model
        SdkHandler defineSdkHandler(ProjectIdentifier projectId) {
            ...
            plugin.sdkHandler = new SdkHandler(rootProjectId.getProjectDir());
            return plugin.sdkHandler
        }
...
//        @Mutate
//        void closeVariantManager(ComponentSpecContainer specContainer, AndroidComponentSpec androidComponents) {
//        }
        ...
        @Mutate
        void createLifeCycleTasks(TaskContainer tasks) {
