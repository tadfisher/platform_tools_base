...
public abstract class BaseExtension {
    ...
    BaseExtension(
        ...
        sourceSets.create(defaultConfig.name)
        sourceSets.create(ANDROID_TEST.prefix)
        sourceSets.create(UNIT_TEST.prefix)
    }
    ...
    public void registerJavaArtifact(
        ...
        extraModelInfo.registerJavaArtifact(name, variant, assembleTaskName, javaCompileTaskName,
    ...
    public void enforceUniquePackageName(boolean value) {
        if (!value) {
            BasePlugin.displayDeprecationWarning(logger, project, "Support for libraries with same package name is deprecated and will be removed in 1.0")
        }
