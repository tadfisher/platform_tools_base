...
public abstract class BaseExtension {
    ...
    final NamedDomainObjectContainer<com.android.build.gradle.internal.dsl.BuildType> buildTypes
    ...
    BaseExtension(
            ...
            @NonNull NamedDomainObjectContainer<com.android.build.gradle.internal.dsl.BuildType> buildTypes,
        ...
        defaultConfig = instantiator.newInstance(com.android.build.gradle.internal.dsl.ProductFlavor, BuilderConstants.MAIN,
     ...
     */
    void buildTypes(Action<? super NamedDomainObjectContainer<com.android.build.gradle.internal.dsl.BuildType>> action) {
        plugin.checkTasksAlreadyCreated()
