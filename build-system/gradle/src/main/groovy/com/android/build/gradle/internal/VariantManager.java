...
import com.android.build.gradle.internal.api.ImmutableObjectProvider;
...
public class VariantManager {
    ...
    @NonNull
    private final ImmutableObjectProvider immutableObjectProvider = new ImmutableObjectProvider();
    @NonNull
    private final VariantFilterImpl variantFilter = new VariantFilterImpl(immutableObjectProvider);
    ...
    private void createVariantApiObjects(
        ...
        BaseVariant variantApi = variantFactory.createVariantApi(variantData,
                immutableObjectProvider);

        TestVariantImpl testVariant = null;
        if (testVariantData != null) {
            testVariant = basePlugin.getInstantiator().newInstance(
                    TestVariantImpl.class, testVariantData, basePlugin, immutableObjectProvider);
