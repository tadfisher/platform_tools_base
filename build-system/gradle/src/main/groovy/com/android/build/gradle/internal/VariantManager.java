...
public class VariantManager {
    ...
    private final VariantControlImpl variantControl = new VariantControlImpl();
    ...
    private void createTasksForDefaultBuild() {
        ...
        Closure<Void> variantControlClosure = basePlugin.getExtension().getVariantControl();

        for (BuildTypeData buildTypeData : buildTypes.values()) {
            boolean ignore = false;
            if (variantControlClosure != null) {
                variantControl.reset(defaultConfig, buildTypeData.getBuildType(), null);
                variantControlClosure.call(variantControl);
                ignore = variantControl.isIgnore();
            }
    ...
    private void createTasksForFlavoredBuild(@NonNull ProductFlavorData... flavorDataList) {
        ...
        Closure<Void> variantControlClosure = basePlugin.getExtension().getVariantControl();
        final List<ProductFlavor> productFlavorList = (variantControlClosure != null) ? Lists.<ProductFlavor>newArrayListWithCapacity(flavorDataList.length) : null;
        ...
        for (BuildTypeData buildTypeData : buildTypes.values()) {
            ...
            if (variantControlClosure != null) {
                ...
                variantControl.reset(defaultConfig, buildTypeData.getBuildType(), productFlavorList);
                variantControlClosure.call(variantControl);
                ignore = variantControl.isIgnore();
            }
