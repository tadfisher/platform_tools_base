...
public class VariantManager {
    ...
    void addSigningConfig(@NonNull SigningConfigDsl signingConfigDsl) {
     ...
     */
    void addBuildType(@NonNull BuildTypeDsl buildType) {
     ...
     */
    void addProductFlavor(@NonNull GroupableProductFlavorDsl productFlavor) {
    ...
    private void createTasksForFlavoredBuild(@NonNull ProductFlavorData... flavorDataList) {
        ...
        for (BuildTypeData buildTypeData : buildTypes.values()) {
            ...
            if (flavorDataList.length > 1) {
                DefaultAndroidSourceSet multiFlavorSourceSet = (DefaultAndroidSourceSet) sourceSetsContainer.maybeCreate(variantConfig.getFullName());
            ...
            VariantDependencies variantDep = VariantDependencies.compute(
                    project, appVariantData.getVariantConfiguration().getFullName(),
