...
public class VariantManager {
    ...
    public void createTasksForVariantData(TaskContainer tasks, BaseVariantData variantData) {
        if (variantData.getVariantConfiguration().getType()
            ...
            List<? extends GroupableProductFlavor> productFlavorList = testedVariantData.getVariantConfiguration().getProductFlavors();
            ...
            if (testedVariantData.getVariantConfiguration().getType() == VariantConfiguration.Type.LIBRARY) {
