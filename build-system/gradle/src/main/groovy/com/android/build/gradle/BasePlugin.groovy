...
import com.android.build.SplitOutput.FilterType;
...
public abstract class BasePlugin {
    ...
    public void createMergeAppManifestsTask(
        ...
        for (BaseVariantOutputData vod : variantData.outputs) {
            final CompatibleScreensManifest csmTask =
                    (vod.getFilter(SplitOutput.FilterType.DENSITY) != null && !screenSizes.isEmpty()) ?
    ...
    private CompatibleScreensManifest createCompatibleScreensManifest(
        ...
        csmTask.screenDensity = variantOutputData.getFilter(SplitOutput.FilterType.DENSITY)
    ...
    public void createProcessResTask(
        ...
        for (BaseVariantOutputData vod : variantData.outputs) {
            ...
            // densityFilter)
            if (variantOutputData.getFilter(SplitOutput.FilterType.DENSITY) == null
            ...
            processResources.conventionMapping.resourceConfigs = {
                ...
                resConfigs.add(variantOutputData.getFilter(SplitOutput.FilterType.DENSITY))
    ...
    public void addPackageTasks(
        ...
        for (ApkVariantOutputData vod : variantData.outputs) {
            ...
            packageApp.conventionMapping.abiFilters = {
                if (variantOutputData.getFilter(SplitOutput.FilterType.ABI) != null) {
                    return ImmutableSet.of(variantOutputData.getFilter(FilterType.ABI))
                }
                ...
                if (extension.publishNonDefault) {
                    ...
                    if (variantOutputData.getFilter(SplitOutput.FilterType.DENSITY) != null) {
                        classifier = classifier + '-'
                            + variantOutputData.getFilter(SplitOutput.FilterType.DENSITY)
                    }
