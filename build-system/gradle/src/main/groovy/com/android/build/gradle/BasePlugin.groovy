...
public abstract class BasePlugin {
    ...
    public void createCompileTestTask(
            @NonNull BaseVariantData<? extends BaseVariantOutputData> variantData) {
        variantData.javaCompileTestTask = project.tasks.create(
            ...
            source = variantData.javaUnitTestSources

            configureBuildGroup it
            dependsOn variantData.compileTask
            return it
        }
    }
    ...
    public void createCheckTasks(boolean hasFlavors) {
        ...
        if (!hasFlavors) {
            Test runTestsTask = project.tasks.create(TEST_TASK_NAME, Test)
            ...
            testTask = runTestsTask
        } else {
            testTask = project.tasks.create(TEST_TASK_NAME)
            testTask.description = "Runs unit tests for all build variants."
            // TODO: Actually create the tasks.
        }

        testTask.group = JavaBasePlugin.VERIFICATION_GROUP
        testTask.description = "Runs all unit tests on the local JVM."
