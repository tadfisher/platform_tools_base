...
public abstract class BasePlugin {
    ...
    public void createMergeAppManifestsTask(
        ...
        for (BaseVariantOutputData vod : variantData.outputs) {
            final CompatibleScreensManifest csmTask =
                    (vod.getFilter(SplitOutput.DENSITY) != null && !screenSizes.isEmpty()) ?
    ...
    private CompatibleScreensManifest createCompatibleScreensManifest(
        ...
        csmTask.screenDensity = variantOutputData.getFilter(SplitOutput.DENSITY)
    ...
    public void createProcessResTask(
        ...
        for (BaseVariantOutputData vod : variantData.outputs) {
            ...
            // densityFilter)
            if (variantOutputData.getFilter(SplitOutput.DENSITY) == null
            ...
            processResources.conventionMapping.resourceConfigs = {
                ...
                resConfigs.add(variantOutputData.getFilter(SplitOutput.DENSITY))
    ...
    public void addPackageTasks(
        ...
        for (ApkVariantOutputData vod : variantData.outputs) {
            ...
            packageApp.conventionMapping.abiFilters = {
                if (variantOutputData.getFilter(SplitOutput.ABI) != null) {
                    return ImmutableSet.of(variantOutputData.getFilter(SplitOutput.ABI))
                }
                ...
                if (extension.publishNonDefault) {
                    ...
                    if (variantOutputData.getFilter(SplitOutput.DENSITY) != null) {
                        classifier = classifier + '-'
                            + variantOutputData.getFilter(SplitOutput.DENSITY)
                    }
