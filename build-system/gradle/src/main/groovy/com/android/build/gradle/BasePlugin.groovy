...
public abstract class BasePlugin {
    ...
    private void checkPathForErrors() {
        ...
        println """
Your project directory contains non-ASCII characters. This will most likely
...
This warning can be disabled by using -D${SKIP_PATH_CHECK_PROPERTY}=true command
line flag or adding the line '${SKIP_PATH_CHECK_PROPERTY}=true' to
gradle.properties file in the project directory.

"""
        throw new StopExecutionException("See the warning above.")
    }
}
