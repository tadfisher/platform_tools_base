    ...
    public void createPostCompilationTasks(@NonNull ApkVariantData variantData) {
        ...
        if (isMultiDexEnabled && isLegacyMultiDexMode) {
            ...
            manifestKeepListTask.outputFile = project.file(
                    "${project.buildDir}/multi-dex/${config.dirName}/manifest_keep.txt")
            ...
            createMainDexListTask.outputFile = project.file(
                    "${project.buildDir}/multi-dex/${config.dirName}/maindexlist.txt")
            ...
            if (isMinifyEnabled) {
                ...
                retraceTask.outputFile = project.file(
                        "${project.buildDir}/multi-dex/${config.dirName}/maindexlist_deobfuscated.txt")
