...
public abstract class BasePlugin {
    ...
    public void createJackTask(
        ...
        compileTask.conventionMapping.runtimeLibraries = {
            project.fileTree(jillRuntimeTask.outputFolder).files
        }
        ...
        compileTask.conventionMapping.jackFolder = {
            project.file("$project.buildDir/${FD_INTERMEDIATES}/jack/${variantData.variantConfiguration.dirName}")
        }
