    ...
    */
    ...
    static String normalize(ILogger logger, ModuleVersionIdentifier id, String path) {
        if (path == null || path.isEmpty()) {
            logger.verbose("path normalization received empty path")
            return path;
        }
        ...
        if (normalizedPath == null || normalizedPath.isEmpty()) {
            ...
            logger.verbose("path normalization failed, input was ${path}")
            return path
        }
        try {
            ...
            logger.error(e, "Path normalization failed, input %s", path)
            return path;
        }
    }
