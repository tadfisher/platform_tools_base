...
public abstract class BasePlugin {
    ...
    public void mergeManifests(BaseVariantData variantData,
        ...
        def processManifestTask = project.tasks.create(
                ...
                MergeManifests)
        variantData.mManifestProcessorTask = processManifestTask
    ...
    public void processManifest(BaseVariantData variantData, String manifestOutDir) {
        if (extension.getUseOldManifestMerger()) {
            createOldProcessManifestTask(variantData, manifestOutDir);
            return;
        }
        ...
        def injectLibraryManifest = project.tasks.create(
                ...
                ProcessManifest)
        variantData.mManifestProcessorTask = injectLibraryManifest
    ...
    protected void createProcessTestManifestTask(BaseVariantData variantData,
        ...
        variantData.mManifestProcessorTask = processTestManifestTask
    ...
    public void createRenderscriptTask(BaseVariantData variantData) {
        ...
        if (config.type == TEST) {
            renderscriptTask.dependsOn variantData.mManifestProcessorTask
        } else {
    ...
    public void createBuildConfigTask(BaseVariantData variantData) {
        ...
        if (variantConfiguration.type == TEST) {
            ...
            // on its creation.
            generateBuildConfigTask.dependsOn variantData.mManifestProcessorTask
        } else {
    ...
    public void createProcessResTask(
        ...
        processResources.dependsOn variantData.mManifestProcessorTask, variantData.mergeResourcesTask, variantData.mergeAssetsTask
    ...
    public void createTestApkTasks(@NonNull TestVariantData variantData,
        ...
        if (testedVariantData.variantConfiguration.type == VariantConfiguration.Type.LIBRARY) {
            ...
            if (testedVariantData.assembleTask != null) {
                variantData.mManifestProcessorTask.dependsOn testedVariantData.assembleTask
