...
public abstract class BasePlugin {
    ...
    private void configureLanguageLevel(AbstractCompile compileTask) {
         ...
         */
        Closure<Integer> getCompileSdkNumber = { String sdkVersionString ->
            if (AndroidTargetHash.isPlatform(sdkVersionString)) {
                return AndroidTargetHash.getPlatformVersion(sdkVersionString).apiLevel
            } else {
                return AndroidTargetHash.getAddOnVersion(sdkVersionString).apiLevel
            }
        }
