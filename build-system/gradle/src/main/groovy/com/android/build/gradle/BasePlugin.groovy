...
public abstract class BasePlugin {
    ...
    public final static String FD_I = "intermediates";
    public final static String FD_O = "outputs";
    public final static String FD_G = "generated";
        ...
        project.gradle.buildFinished {
            ...
            PreDexCache.getCache().clear(
                    project.rootProject.file(
                            "${project.rootProject.buildDir}/${FD_I}/dex-cache/cache.xml"),
                    logger)
    ...
    public void createProcessManifestTask(BaseVariantData variantData,
        ...
        processManifestTask.conventionMapping.manifestOutputFile = {
            project.file(
                    "$project.buildDir/${FD_I}/${manifestOutDir}/" +
    ...
    public void createOldProcessManifestTask(BaseVariantData variantData,
        ...
        processManifestTask.conventionMapping.manifestOutputFile = {
            project.file(
                    "$project.buildDir/${FD_I}/${manifestOurDir}/${variantData.variantConfiguration.dirName}/AndroidManifest.xml")
        }
    }
    ...
    public void createRenderscriptTask(BaseVariantData variantData) {
        ...
        renderscriptTask.conventionMapping.sourceOutputDir = {
            project.file("$project.buildDir/${FD_G}/source/rs/${variantData.variantConfiguration.dirName}")
        }
        renderscriptTask.conventionMapping.resOutputDir = {
            project.file("$project.buildDir/${FD_G}/res/rs/${variantData.variantConfiguration.dirName}")
        }
        renderscriptTask.conventionMapping.objOutputDir = {
            project.file("$project.buildDir/${FD_I}/rs/${variantData.variantConfiguration.dirName}/obj")
        }
        renderscriptTask.conventionMapping.libOutputDir = {
            project.file("$project.buildDir/${FD_I}/rs/${variantData.variantConfiguration.dirName}/lib")
        }
    ...
    public void createMergeResourcesTask(@NonNull BaseVariantData variantData,
        ...
        MergeResources mergeResourcesTask = basicCreateMergeResourcesTask(
                variantData,
                "merge",
                "$project.buildDir/${FD_I}/res/${variantData.variantConfiguration.dirName}",
    ...
    public MergeResources basicCreateMergeResourcesTask(
        ...
        mergeResourcesTask.incrementalFolder = project.file(
                "$project.buildDir/${FD_I}/incremental/${taskNamePrefix}Resources/${variantData.variantConfiguration.dirName}")
    ...
    public void createMergeAssetsTask(@NonNull BaseVariantData variantData,
        ...
        if (outputLocation == null) {
            outputLocation = "$project.buildDir/${FD_I}/assets/${variantData.variantConfiguration.dirName}"
        }
        ...
        mergeAssetsTask.incrementalFolder =
                project.file("$project.buildDir/${FD_I}/incremental/mergeAssets/${variantData.variantConfiguration.dirName}")
    ...
    public void createBuildConfigTask(BaseVariantData variantData) {
        ...
        generateBuildConfigTask.conventionMapping.sourceOutputDir = {
            project.file("$project.buildDir/${FD_G}/source/buildConfig/${variantData.variantConfiguration.dirName}")
        }
    }
    ...
    public void createGenerateResValuesTask(BaseVariantData variantData) {
        ...
        generateResValuesTask.conventionMapping.resOutputDir = {
            project.file("$project.buildDir/${FD_G}/res/generated/${variantData.variantConfiguration.dirName}")
        }
    }
    ...
    public void createProcessResTask(
        ...
        createProcessResTask(variantData,
                "$project.buildDir/${FD_I}/symbols/${variantData.variantConfiguration.dirName}",
    ...
    public void createProcessResTask(
        ...
        processResources.conventionMapping.sourceOutputDir = {
            project.file("$project.buildDir/${FD_G}/source/r/${variantData.variantConfiguration.dirName}")
        }
        ...
        if (generateResourcePackage) {
            processResources.conventionMapping.packageOutputFile = {
                project.file(
                        "$project.buildDir/${FD_I}/libs/${project.archivesBaseName}-${variantData.variantConfiguration.baseName}.ap_")
            }
        }
        if (variantConfiguration.buildType.runProguard) {
            processResources.conventionMapping.proguardOutputFile = {
                project.file("$project.buildDir/${FD_I}/proguard/${variantData.variantConfiguration.dirName}/aapt_rules.txt")
            }
        }
    ...
    public void createProcessJavaResTask(BaseVariantData variantData) {
        ...
        processResources.conventionMapping.destinationDir = {
            project.file("$project.buildDir/${FD_I}/javaResources/${variantData.variantConfiguration.dirName}")
        }
    }
    ...
    public void createAidlTask(@NonNull BaseVariantData variantData, @Nullable File parcelableDir) {
        ...
        compileTask.incrementalFolder =
                project.file("$project.buildDir/${FD_I}/incremental/aidl/${variantData.variantConfiguration.dirName}")
        ...
        compileTask.conventionMapping.sourceOutputDir = {
            project.file("$project.buildDir/${FD_G}/source/aidl/${variantData.variantConfiguration.dirName}")
        }
    ...
    public void createCompileTask(BaseVariantData variantData,
        ...
        compileTask.conventionMapping.destinationDir = {
            project.file("$project.buildDir/${FD_I}/classes/${variantData.variantConfiguration.dirName}")
        }
        compileTask.conventionMapping.dependencyCacheDir = {
            project.file("$project.buildDir/${FD_I}/dependency-cache/${variantData.variantConfiguration.dirName}")
        }
    ...
    public void createNdkTasks(@NonNull BaseVariantData variantData) {
        ...
        ndkCompile.conventionMapping.generatedMakefile = {
            project.file("$project.buildDir/${FD_I}/ndk/${variantData.variantConfiguration.dirName}/Android.mk")
        }
        ...
        ndkCompile.conventionMapping.objFolder = {
            project.file("$project.buildDir/${FD_I}/ndk/${variantData.variantConfiguration.dirName}/obj")
        }
        ndkCompile.conventionMapping.soFolder = {
            project.file("$project.buildDir/${FD_I}/ndk/${variantData.variantConfiguration.dirName}/lib")
        }
    }
    ...
    public void createLintCompileTask() {
        ...
        File outputDir = new File("$project.buildDir/${FD_I}/lint")
        ...
        if (hasFlavors) {
            ...
            mainConnectedTask.conventionMapping.resultsDir = {
                String rootLocation = extension.testOptions.resultsDir != null ?
                    extension.testOptions.resultsDir : "$project.buildDir/${FD_O}/$FD_ANDROID_RESULTS"
            ...
            mainConnectedTask.conventionMapping.reportsDir = {
                String rootLocation = extension.testOptions.reportDir != null ?
                    ...
                    "$project.buildDir/${FD_O}/$FD_REPORTS/$FD_ANDROID_TESTS"
            ...
            if (baseVariantData instanceof TestedVariantData) {
                ...
                if (baseVariantData.variantConfiguration.buildType.isTestCoverageEnabled()) {
                    ...
                    reportTask.conventionMapping.reportDir = {
                        ...
                        project.file(
                                "$project.buildDir/${FD_O}/$FD_REPORTS/coverage/${baseVariantData.variantConfiguration.dirName}")
                    }
    ...
    private DeviceProviderInstrumentTestTask createDeviceProviderInstrumentTestTask(
        ...
        testTask.conventionMapping.resultsDir = {
            String rootLocation = extension.testOptions.resultsDir != null ?
                ...
                "$project.buildDir/${FD_O}/$FD_ANDROID_RESULTS"
        ...
        testTask.conventionMapping.coverageDir = {
            String rootLocation = "$project.buildDir/${FD_O}/code-coverage"
    ...
    public void addPackageTasks(@NonNull ApkVariantData variantData,
        ...
        dexTask.conventionMapping.outputFolder = {
            project.file("${project.buildDir}/${FD_I}/dex/${variantConfig.dirName}")
        }
        ...
        if (runProguard) {
            ...
            if (runInstrumentation) {
                ...
                jacocoTask.conventionMapping.outputDir = {
                    project.file("${project.buildDir}/${FD_I}/coverage-instrumented-classes/${variantConfig.dirName}")
                }
            ...
            if (runPreDex) {
                ...
                dexTask.conventionMapping.libraries = {
                    Set<File> set = androidBuilder.getPackagedJars(variantConfig)
                    if (jacocoTask != null) {
                        set.add(project.file("$project.buildDir/${FD_I}/jacoco/jacocoagent.jar"))
                    }
        ...
        packageApp.conventionMapping.outputFile = {
            project.file("$project.buildDir/${FD_O}/apk/${apkName}")
        }
        ...
        if (signedApk) {
            if (variantData.zipAlign) {
                ...
                zipAlignTask.conventionMapping.outputFile = {
                    project.file(
                            "$project.buildDir/${FD_O}/apk/${project.archivesBaseName}-${variantData.variantConfiguration.baseName}.apk")
                }
    ...
    public Copy getJacocoAgentTask() {
        if (jacocoAgentTask == null) {
            ...
            jacocoAgentTask.into "$project.buildDir/${FD_I}/jacoco"
        }
    ...
    public File createProguardTasks(@NonNull BaseVariantData variantData,
        ...
        if (variantData instanceof LibraryVariantData) {
            outFile = project.file(
                    "${project.buildDir}/${FD_I}/$DIR_BUNDLES/${variantData.variantConfiguration.dirName}/classes.jar")
        } else {
            outFile = project.file(
                    "${project.buildDir}/${FD_I}/classes-proguard/${variantData.variantConfiguration.dirName}/classes.jar")
        }
        ...
        if (testedVariantData != null) {
            ...
            proguardTask.applymapping("${project.buildDir}/${FD_O}/proguard/${testedVariantData.variantConfiguration.dirName}/mapping.txt")
        ...
        final File proguardOut = project.file(
                "${project.buildDir}/${FD_O}/proguard/${variantData.variantConfiguration.dirName}")
            ...
            moduleArtifacts?.each { artifact ->
                if (artifact.type == EXT_LIB_ARCHIVE) {
                    ...
                    def explodedDir = project.file(
                            "$project.rootProject.buildDir/${FD_I}/exploded-aar/$path")
