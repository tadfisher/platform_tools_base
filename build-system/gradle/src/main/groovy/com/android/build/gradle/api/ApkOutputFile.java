 ...
 */
public class ApkOutputFile implements OutputFile {
    ...
    public ApkOutputFile(
            ...
            @Nullable String splitSuffix,
            @NonNull File outputFile) {
        this.outputFile = outputFile;
        this.outputType = outputType;
        this.filters = ImmutableList.of(FilterData.Builder.build(
                filterType.name(), splitIdentifier));
        this.filterTypes = ImmutableList.of(filterType.name());
        this.splitSuffix = Optional.fromNullable(splitSuffix);
    }
