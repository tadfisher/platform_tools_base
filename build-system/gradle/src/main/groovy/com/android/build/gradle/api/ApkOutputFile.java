...
public class ApkOutputFile implements OutputFile, Serializable {
    ...
    public static <V> SerializableCallable<V> returning(final V object) {
        return new SerializableCallable<V>() {
            @Override
    ...
    public static interface SerializableCallable<V> extends Serializable, Callable<V> {
    }
    ...
    public static class JsonDeserializer implements com.google.gson.JsonDeserializer<ApkOutputFile> {
        ...
        public ApkOutputFile deserialize(JsonElement jsonElement, Type type,
            ...
            return new ApkOutputFile(
                    ...
                    ApkOutputFile.returning(new File(jsonObject.get("outputFile").getAsString())));
        }
    }
