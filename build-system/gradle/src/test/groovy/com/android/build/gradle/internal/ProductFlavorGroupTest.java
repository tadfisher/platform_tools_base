...
public class ProductFlavorGroupTest {
    ...
    public void getNameEmpty() {
        assertEquals("", new ProductFlavorGroup().getName());
    }

    @Test
    public void getNameSingleFlavor() {
        assertEquals("flavor1", new ProductFlavorGroup(f1).getName());
    }

    @Test
    public void getNameMultiFlavor() {
        assertEquals("flavor1Flavor2", new ProductFlavorGroup(f1, f2).getName());
    }

    @Test
    public void createGroupListEmpty() throws Exception {
        assertEqualGroupList(
                ImmutableList.<ProductFlavorGroup>of(),
                ProductFlavorGroup.createGroupList(
    ...
    public void createGroupListSingleDimension() throws Exception {
        assertEqualGroupList(
                ImmutableList.of(new ProductFlavorGroup(f1d1)),
                ProductFlavorGroup.createGroupList(
    ...
    public void createGroupListDimensionWithoutFlavor() throws Exception {
        assertEqualGroupList(
                ImmutableList.of(new ProductFlavorGroup(f1d2)),
                ProductFlavorGroup.createGroupList(
    ...
    public void createGroupListMultiDimensions() throws Exception {
        assertEqualGroupList(
                ImmutableList.of(
                        new ProductFlavorGroup(f1d1, f1d2),
                        new ProductFlavorGroup(f1d1, f2d2),
                        new ProductFlavorGroup(f2d1, f1d2),
                        new ProductFlavorGroup(f2d1, f2d2)),
                ProductFlavorGroup.createGroupList(
                        ImmutableList.of(DIMENSION1, DIMENSION2),
    ...
    private static void assertEqualGroupList(List<ProductFlavorGroup> expected, List<ProductFlavorGroup> actual) {
