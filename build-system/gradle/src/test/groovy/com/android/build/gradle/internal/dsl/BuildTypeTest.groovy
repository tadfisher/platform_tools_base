...
public class BuildTypeTest extends BaseTest {
    ...
    public void testInitWith() {
        ...
        DefaultGradleBuildType object1 = new DefaultGradleBuildType("foo", project, project.getLogger())
        ...
        DefaultGradleBuildType object2 = new DefaultGradleBuildType(object1.name, project, project.getLogger())
