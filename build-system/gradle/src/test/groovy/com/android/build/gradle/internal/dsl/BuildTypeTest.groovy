...
public class BuildTypeTest extends BaseTest {
    ...
    public void testInitWith() {
        ...
        GradleBuildTypeImpl object1 = new GradleBuildTypeImpl("foo", project, project.getLogger())
        ...
        GradleBuildTypeImpl object2 = new GradleBuildTypeImpl(object1.name, project, project.getLogger())
