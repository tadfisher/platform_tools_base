...
public class ManualBuildTest extends BuildTest {
    ...
    public void testPureAbiSplits() throws Exception {
        ...
        Map<String, VersionData> expected = Maps.newHashMapWithExpectedSize(8);
        expected.put("freeDebug-armeabi-v7a",      VersionData.of(1100123));
        expected.put("freeDebug-mips",             VersionData.of(1100123));
        expected.put("freeDebug-x86",              VersionData.of(1100123));
        expected.put("paidDebug-armeabi-v7a",      VersionData.of(1100123));
        expected.put("paidDebug-mips",             VersionData.of(1100123));
        expected.put("paidDebug-x86",              VersionData.of(1100123));
