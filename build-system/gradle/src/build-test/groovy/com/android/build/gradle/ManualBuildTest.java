...
public class ManualBuildTest extends BuildTest {
    ...
    public void testShrinkResources() throws Exception {
        ...
        assertFalse(new File(intermediates,
                "res" + separator + "resources-debug-compressed.ap_").exists());
        assertTrue(new File(intermediates,
                "res" + separator + "resources-proguardNoShrink.ap_").exists());
        assertFalse(new File(intermediates,
                "res" + separator + "resources-proguardNoShrink-compressed.ap_").exists());
        ...
        String expectedUnstrippedApk = ""
                ...
                + "res/layout/unused3.xml\n"
                + "res/layout/unused4.xml\n"
                + "res/layout/unused5.xml\n"
                + "res/layout/unused6.xml\n"
                + "res/layout/unused7.xml\n"
                + "res/layout/unused8.xml\n"
