    ...
    static void setUp() {
        project.getBuildFile() << """
            ...
            android {
                ...
                defaultConfig {
                    resValue "integer", "VALUE_DEFAULT", "1"
                    resValue "integer", "VALUE_DEBUG",   "1"
                    resValue "integer", "VALUE_FLAVOR",  "1"
                    resValue "integer", "VALUE_VARIANT", "1"
                }

                buildTypes {
                    debug {
                        resValue "integer", "VALUE_DEBUG",   "100"
                        resValue "integer", "VALUE_VARIANT", "100"
                    }
                }

                productFlavors {
                    flavor1 {
                        resValue "integer", "VALUE_DEBUG",   "10"
                        resValue "integer", "VALUE_FLAVOR",  "10"
                        resValue "integer", "VALUE_VARIANT", "10"
                    }
                    flavor2 {
                        resValue "integer", "VALUE_DEBUG",   "20"
                        resValue "integer", "VALUE_FLAVOR",  "20"
                        resValue "integer", "VALUE_VARIANT", "20"
                    }
                }

                applicationVariants.all { variant ->
                    if (variant.buildType.name == "debug") {
                        variant.resValue "integer", "VALUE_VARIANT", "1000"
                    }
                }
            }
            """.stripIndent()
...
<resources>
    ...
    <item name="VALUE_VARIANT" type="integer">1000</item>
    <!-- Values from build type: debug -->
    <item name="VALUE_DEBUG" type="integer">100</item>
    <!-- Values from product flavor: flavor1 -->
    <item name="VALUE_FLAVOR" type="integer">10</item>
    <!-- Values from default config. -->
    <item name="VALUE_DEFAULT" type="integer">1</item>
...
<resources>
    ...
    <item name="VALUE_FLAVOR" type="integer">20</item>
    <!-- Values from default config. -->
    <item name="VALUE_DEFAULT" type="integer">1</item>
...
<resources>
    ...
    <!-- Values from product flavor: flavor1 -->
    <item name="VALUE_DEBUG" type="integer">10</item>
    <item name="VALUE_FLAVOR" type="integer">10</item>
    <item name="VALUE_VARIANT" type="integer">10</item>
    <!-- Values from default config. -->
    <item name="VALUE_DEFAULT" type="integer">1</item>
...
<resources>
    ...
    <!-- Values from product flavor: flavor2 -->
    <item name="VALUE_DEBUG" type="integer">20</item>
    <item name="VALUE_FLAVOR" type="integer">20</item>
    <item name="VALUE_VARIANT" type="integer">20</item>
    <!-- Values from default config. -->
    <item name="VALUE_DEFAULT" type="integer">1</item>
