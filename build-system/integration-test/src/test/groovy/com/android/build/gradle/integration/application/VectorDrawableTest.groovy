...
class VectorDrawableTest {
    ...
    public void "vector file is moved and PNGs are generated"() throws Exception {
        ...
        File originalPng = new File(
                project.testDir,
                "build/intermediates/res/merged/debug/drawable-hdpi-v4/specialheart.png")
        ...
        assertThat(FileUtils.sha1(originalPng)).isNotEqualTo(FileUtils.sha1(generatedPng))
        assertThat(FileUtils.sha1(pngToUse)).isEqualTo(FileUtils.sha1(originalPng))
        ...
        assertThat(FileUtils.sha1(pngToUse)).isEqualTo(FileUtils.sha1(generatedPng))
    }
    ...
    public void "incremental build: delete png"() throws Exception {
        ...
        assertThat(FileUtils.sha1(pngToUse)).isNotEqualTo(FileUtils.sha1(generatedPng))
    ...
    public void "incremental build: modify xml"() throws Exception {
        ...
        File preprocessedHeartXml = new File(
                project.testDir,
                "build/intermediates/res/preprocessed/debug/drawable-hdpi-v4/heart.png")
        ...
        assertThat(FileUtils.sha1(preprocessedHeartXml)).isNotEqualTo(oldHashCode)
    }
