...
"""
    ...
    public void nullBuild() {
        ...
        assert_().withFailureMessage("Expecting tasks to be UP-TO-DATE")
...
android {
    compileSdkVersion $GradleTestProject.DEFAULT_COMPILE_SDK_VERSION
    buildToolsVersion "${
            // switch to a different build tools version.
...
"""
        ...
        assert_().withFailureMessage("Expecting tasks to be invalidated")
