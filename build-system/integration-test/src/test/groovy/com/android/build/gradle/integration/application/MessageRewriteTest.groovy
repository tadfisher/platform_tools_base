...
class MessageRewriteTest {
    ...
    public void "invalid layout file"() {
        TemporaryProjectModification modification = new TemporaryProjectModification(project);
        modification.replaceInFile("src/main/res/layout/main.xml", "</LinearLayout>", "");
