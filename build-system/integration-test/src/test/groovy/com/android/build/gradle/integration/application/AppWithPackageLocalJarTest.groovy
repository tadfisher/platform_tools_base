...
"""
    ...
    @Test
    void "check provided local jar is not in the model"() {
    ...
    @Test
    void "check provided local jar is not in the android test dependency"() {
    }

    @Test
    void "check provided local jar is not in the unit test dependency"() {
    }
}
