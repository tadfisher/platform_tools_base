...
class AndroidTestResourcesTest {
    ...
    @ClassRule
    public static GradleTestProject libProject = GradleTestProject.builder().withName("library")
            .create()
    ...
    @BeforeClass
    static void setup() {
        testApp.writeSources(appProject.getSourceDir())
        ...
        testApp.writeSources(libProject.getSourceDir())
    ...
    void "Check test layout can be used in device tests"() {
