...
public class FakeRemoteTestRunner extends RemoteTestRunner {
    ...
    @Override
    public Map<String, String[]> runTests(TestData testData) {
        System.out.println("RUN TESTS CALLED");

        Map<String, String[]> results = new HashMap<String, String[]>();
        List<String> abis = new ArrayList<String>();
        abis.add("x86");
        List<File> apks = testData.getTestedApks(160 /* density */, "en" /* language */,
                null /* region */, abis);
