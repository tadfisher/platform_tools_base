            ...
            if (matcher.matches()) {
                while (matcher.matches()) {
                    ...
                    if (placeholderValue == null) {
                        ...
                        // we add back the placeholder key, for libraries, this is not an error.
                        ...
                        // subsitute the placeholder key with its value.
                    ...
                    // do we have more placeholder on the remaining of the string.
                    matcher = PATTERN.matcher(inputString);
                }
                // append the remaining (without placeholders) in the result string.
