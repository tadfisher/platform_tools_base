...
/**
 * Describes an attribute characteristics like it is supports smart package name replacement, has
...
public class AttributeModel {
    ...
    static interface Validator {
         ...
         */
        boolean validates(MergingReport.Builder mergingReport, XmlAttribute attribute, String value);
    }

    /**
     * Validates a boolean attribute type.
     */
    public static class BooleanValidator implements Validator {
        ...
        @Override
        public boolean validates(MergingReport.Builder mergingReport, XmlAttribute attribute,
                String value) {
