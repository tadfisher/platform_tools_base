...
public class Actions {
    ...
    //
    //    private final SourceFile mSourceLocation;
    //
    //    private final Position mPosition;
    //
    //    public ActionLocation(@NonNull SourceFile sourceLocation,
    ...
    //    }
    //
    //    public SourceFile getSourceLocation() {
    ...
    //        if (mPosition != null) {
    //            toString += ":" + mPosition.getStartLine() + ":" + mPosition.getStartColumn();
    //        }
    //        return toString;
    //    }
    //
    ...
    //            jsonObject.addProperty(LINE_ATTRIBUTE, src.getPosition().getStartLine());
    //            jsonObject.addProperty(COLUMN_ATTRIBUTE, src.getPosition().getStartColumn());
    //            jsonObject.addProperty(OFFSET_ATTRIBUTE, src.getPosition().getStartOffset());
    //            return jsonObject;
    //        }
    //    }
    //}
