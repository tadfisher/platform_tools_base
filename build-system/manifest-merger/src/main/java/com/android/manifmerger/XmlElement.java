...
public class XmlElement implements XmlNode {
    ...
    public boolean mergeChildren(XmlElement lowerPriorityNode, MergingReport.Builder mergingReport) {
        ...
        for (XmlElement lowerPriorityChild : lowerPriorityNode.getMergeableElements()) {
            ...
            if (thisChildNodeOptional.isPresent()) {
                ...
                logger.fine(lowerPriorityChild.getXml().toString() + " defined in both files...");
                ...
                if (thisChildNode.getType().getMergeType() != MergeType.MERGE
                        && !thisChildNode.compareXml(lowerPriorityChild, mergingReport)) {
    ...
    public boolean compareXml(XmlElement otherNode, MergingReport.Builder mergingReport) {
