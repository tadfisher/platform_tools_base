...
public class ActionRecorder {
    ...
    enum ActionType {
        ...
        /**
         * The element was not added because it was not declared explicitly by high priority node
         * and merging policy for this attribute yielded the same value as the default value.
         */
        IMPLICIT,

        /**
         * The explicit attribute replaced an implicit default value.
         */
        IMPLICIT_REJECTED,
