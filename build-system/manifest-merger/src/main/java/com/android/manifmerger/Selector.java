...
/**
 * Represents a selector to be able to identify a manifest file xml element.
 */
public class Selector {
    ...
    /**
     * Returns true if the passed element is "selected" by this element. If so, any action this
