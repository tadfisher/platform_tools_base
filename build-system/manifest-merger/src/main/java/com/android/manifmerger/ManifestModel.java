...
class ManifestModel {
     ...
     * combined two attributes value to create the key value.
     */
    private static final class TwoAttributesBasedKeyResolver implements NodeKeyResolver {
        private final NodeKeyResolver firstAttributeResolver;
        private final NodeKeyResolver secondAttributeKeyResolver;

        private TwoAttributesBasedKeyResolver(NodeKeyResolver firstAttributeResolver,
                NodeKeyResolver secondAttributeKeyResolver) {
            this.firstAttributeResolver = firstAttributeResolver;
        ...
        @Override
        public String getKey(Element xmlElement) {
            String firstKey = firstAttributeResolver.getKey(xmlElement);
        ...
        @Override
        public ImmutableList<String> getKeyAttributesNames() {
            return ImmutableList.of(firstAttributeResolver.getKeyAttributesNames().get(0),
