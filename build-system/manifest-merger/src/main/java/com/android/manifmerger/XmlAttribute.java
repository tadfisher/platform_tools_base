...
public class XmlAttribute extends XmlNode {
    ...
    private String mergeThisAndDefaultValue(MergingReport.Builder mergingReport,
        ...
        if (defaultValue.equals(mergedValue)) {
            ...
            // if the merged value is the same as the implicit value virtually declared on the
            // higher priority node, do not add the attribute, keep the implicit declaration.
