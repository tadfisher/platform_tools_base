...
public class PreValidator {
    ...
    private MergingReport.Result overallResult = MergingReport.Result.SUCCESS;
     ...
     */
    public static MergingReport.Result validate(XmlDocument xmlDocument, ILogger logger) {
    ...
    private void updateResult(MergingReport.Result result) {
        if (result == MergingReport.Result.ERROR
                ...
                && overallResult != MergingReport.Result.ERROR)) {
