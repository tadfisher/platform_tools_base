...
public abstract class XmlNode {
     ...
     */
    public int getLine() {
        return getPosition().getStartLine();
    }
    ...
    public int getColumn() {
        return getPosition().getStartColumn();
    }
    ...
    public String printPosition(boolean shortFormat) {
        ...
        return new StringBuilder()
                .append(getSourceFile().print(shortFormat))
                .append(":").append(position.getStartLine()+1)
                .append(":").append(position.getStartColumn()+1)
                .toString();
    }
