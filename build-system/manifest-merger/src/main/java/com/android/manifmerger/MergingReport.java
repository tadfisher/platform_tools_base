...
public class MergingReport {
    ...
    static class Builder {
        ...
        Builder addMessage(@NonNull SourceFile errorLocation,
                int line,
                int column,
            ...
            return addMessage(
                    new SourceFilePosition(
                            errorLocation,
                            new SourcePosition(line - 1, column -1, -1)),
                    severity,
                    message);
        }
        Builder addMessage(@NonNull SourceFilePosition errorLocation,
                    @NonNull Record.Severity severity,
                    @NonNull String message) {
            switch (severity) {
                case ERROR:
            ...
            mRecordBuilder.add(new Record(
                    errorLocation,  severity, message));
            return this;
        }
