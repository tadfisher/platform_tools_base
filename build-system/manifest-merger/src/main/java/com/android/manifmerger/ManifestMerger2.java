...
public class ManifestMerger2 {
    ...
    public interface AutoAddingProperty {
         ...
         */
        void addTo(Document document, String value);
    }
    ...
    public static enum SystemProperty implements AutoAddingProperty {
        ...
        VERSION_CODE {
            @Override
            public void addTo(Document document, String value) {
                addToElementAndroidNS(this, value, document.getDocumentElement());
            }
        },
        /**
        ...
        MIN_SDK_VERSION {
            @Override
            public void addTo(Document document, String value) {
                addToElementAndroidNS(this, value, createOrGetUseSdk(document));
            }
        },
        /**
        ...
        // utility method to add a namespace aware attribute which name is derived from the enum
        // name().
        private static void addToElementAndroidNS(SystemProperty systemProperty,
                String value,
                Element to) {
