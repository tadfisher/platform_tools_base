...
public class ManifestMerger2 {
     ...
     * @throws com.android.manifmerger.ManifestMerger2.MergeFailureException if the merging cannot be completed (for instance, if xml
    ...
    private MergingReport merge() throws MergeFailureException {
        ...
        // force main manifest for resulting merged file when creating a library manifest.
