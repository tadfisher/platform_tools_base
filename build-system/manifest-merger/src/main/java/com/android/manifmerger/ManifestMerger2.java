...
public class ManifestMerger2 {
     ...
     * @param iLogger the logger interface to use.
     ...
     */
    public static Invoker newInvoker(@NonNull File mainManifestFile, @NonNull ILogger iLogger) {
        return new Invoker(mainManifestFile, iLogger);
    }
    ...
    public static final class Invoker {
         ...
         * @param iLogger the logger interface to use.
         */
        private Invoker(@NonNull File mainManifestFile, @NonNull ILogger iLogger) {
