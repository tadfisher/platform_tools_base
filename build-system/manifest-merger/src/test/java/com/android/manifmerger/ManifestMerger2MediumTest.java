 ...
 */
public class ManifestMerger2MediumTest extends ManifestMergerTest {
    ...
    public static Test suite() {
        ...
        for (String fileName : sDataFiles) {
            suite.addTest(TestSuite.createTest(ManifestMerger2MediumTest.class, fileName));
        }

        return suite;
    }

    public ManifestMerger2MediumTest(String testName) {
        super(testName);
    }
