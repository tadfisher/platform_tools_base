...
public class XmlNodeTest extends TestCase {
    ...
    public void testToolsNodeInstructions()
        ...
        Optional<XmlNode> activity = xmlDocument.getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.ACTIVITY, "com.example.lib3.activityOne");
        ...
        activity = xmlDocument.getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.ACTIVITY, "com.example.lib3.activityTwo");
        assertTrue(activity.isPresent());
        assertEquals(NodeOperationType.REMOVE_ALL,
                activity.get().getOperationType());
        activity = xmlDocument.getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.ACTIVITY, "com.example.lib3.activityThree");
        assertTrue(activity.isPresent());
    ...
    public void testAttributeInstructions()
        ...
        Optional<XmlNode> activityOptional = xmlDocument.getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.ACTIVITY, "com.example.lib3.activityOne");
        ...
        activityOptional = xmlDocument.getRootNode()
                .getNodeByTypeAndKey(XmlModel.NodeTypes.ACTIVITY,
    ...
    public void testDiff1()
        ...
        assertTrue(refDocument.getRootNode().getNodeByTypeAndKey(XmlModel.NodeTypes.ACTIVITY,
                "com.example.lib3.activityOne").get()
                .compareXml(
                        otherDocument.getRootNode().getNodeByTypeAndKey(
                                XmlModel.NodeTypes.ACTIVITY, "com.example.lib3.activityOne").get(),
                        mergingReport));
    }
    ...
    public void testDiff5()
        ...
        assertTrue(refDocument.getRootNode().compareXml(otherDocument.getRootNode(),
                mergingReport));
    }
