...
public class XmlElementTest extends TestCase {
    ...
    public void testDiff5()
        ...
        assertFalse(refDocument.getRootNode().compareTo(otherDocument.getRootNode(),
                mergingReport).isPresent());
    }
    ...
    public void testElementReplacement()
        ...
        assertFalse(refDocument.getRootNode().getNodeByTypeAndKey(ManifestModel.NodeTypes.ACTIVITY,
                "com.example.lib3.activityOne").get().compareTo(
                activityOne.get(), mergingReport).isPresent());
    }
