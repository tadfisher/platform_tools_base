...
public class AttributeModelTest extends TestCase {
    ...
    public void testOrMergingPolicy() {
        assertEquals("true", AttributeModel.OR_MERGING_POLICTY.merge("true", "true"));
        assertEquals("true", AttributeModel.OR_MERGING_POLICTY.merge("true", "false"));
        assertEquals("true", AttributeModel.OR_MERGING_POLICTY.merge("false", "true"));
        assertEquals("false", AttributeModel.OR_MERGING_POLICTY.merge("false", "false"));
    }
}
