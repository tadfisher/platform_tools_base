...
public class ManifestMerger2SmallTest extends TestCase {
    ...
    public void testAddingSystemProperties()
        ...
        assertEquals("101", document.getXml().getDocumentElement().getAttribute("versionCode"));

        ManifestMerger2.SystemProperty.VERSION_NAME.addTo(document.getXml(), "1.0.1");
        assertEquals("1.0.1", document.getXml().getDocumentElement().getAttribute("versionName"));
        ...
        assertEquals("10", usesSdk.getAttribute("minSdkVersion"));
        ...
        assertNotNull(usesSdk);
        assertEquals("14", usesSdk.getAttribute("targetSdkVersion"));
    }
