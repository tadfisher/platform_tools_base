...
public class XmlDocumentTest extends TestCase {
    ...
    public void testMergeableElementsIdentification()
        ...
        ImmutableList<XmlNode> mergeableElements = xmlDocument.getRootNode().getMergeableElements();
    ...
    public void testGetXmlNodeByTypeAndKey()
        ...
        assertTrue(xmlDocument.getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.ACTIVITY, "com.example.lib3.activityOne").isPresent());
        assertFalse(xmlDocument.getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.ACTIVITY, "noName").isPresent());
    }
    ...
    public void testSimpleMerge()
        ...
        assertTrue(mergedDocument.get().getRootNode().getNodeByTypeAndKey(
                XmlModel.NodeTypes.APPLICATION, null).isPresent());
        Optional<XmlNode> activityOne = mergedDocument.get()
                .getRootNode().getNodeByTypeAndKey(XmlModel.NodeTypes.ACTIVITY,
    ...
    public void testDiff1()
        ...
        assertFalse(
                mainDocument.getRootNode().compareXml(libraryDocument.getRootNode(),
                        mergingReport));
    }
    ...
    public void testDiff2()
        ...
        assertTrue(mainDocument.getRootNode().compareXml(
    ...
    public void testDiff3()
        ...
        assertTrue(mainDocument.getRootNode().compareXml(libraryDocument.getRootNode(),
                mergingReport));
    }
