 ...
 */
public class ProductFlavorCombo<T extends Groupable & Named> {
    private String name;
     ...
     */
    @NonNull
    public static <S extends Groupable & Named> List<ProductFlavorCombo<S>> createCombinations(
    ...
    private static <S extends Groupable & Named> void createProductFlavorCombinations(
