...
public class PreDexTransform implements Transform {
    ...
    @NonNull
    private final Callable<DexOptions> dexOptions;
    ...
    public PreDexTransform(
            @NonNull Callable<DexOptions> dexOptions,
            boolean multiDex,
    ...
    public Map<String, Object> getParameterInputs() {
        try {
            DexOptions options = dexOptions.call();

            Map<String, Object> params = Maps.newHashMapWithExpectedSize(3);

            params.put("incremental", options.getIncremental());
            params.put("jumbo", options.getJumboMode());
    ...
    public void transform(
        ...
        try {
            ...
            DexOptions resolvedDexOptions = dexOptions.call();
            ...
            for (final File file : inputFileDetails) {
                Callable<Void> action = new PreDexTask(outputFolder, file, hashs,
                        multiDex, resolvedDexOptions, androidBuilder, outputHandler);
    ...
    private static final class PreDexTask implements Callable<Void> {
