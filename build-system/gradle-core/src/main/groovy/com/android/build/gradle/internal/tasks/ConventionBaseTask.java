...
import com.android.build.gradle.internal.FileHelper;
...
public abstract class ConventionBaseTask extends BaseTask implements IConventionAware {
    ...
    protected void emptyFolder(File folder) {
        getLogger().info("deleteDir(" + folder + ") returned: " + FileHelper.deleteDir(folder));
        folder.mkdirs();
    }
