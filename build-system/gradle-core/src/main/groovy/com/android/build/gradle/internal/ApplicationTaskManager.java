...
public class ApplicationTaskManager extends TaskManager {
    ...
    public ApplicationTaskManager(Project project, AndroidBuilder androidBuilder,
            AndroidConfig extension, SdkHandler sdkHandler, DependencyManager dependencyManager,
            ToolingModelBuilderRegistry toolingRegistry) {
        super(project, androidBuilder, extension, sdkHandler, dependencyManager, toolingRegistry);
    }

    @Override
    public void createTasksForVariantData(@NonNull final TaskFactory tasks,
        ...
        ThreadRecorder.get().record(ExecutionType.APP_TASK_MANAGER_CREATE_MERGE_RESOURCES_TASK,
                new Recorder.Block<AndroidTask<MergeResources>>() {
                    @Override
                    public AndroidTask<MergeResources> call() {
                        return createMergeResourcesTask(tasks, variantScope);
                    }
                });
                ...
                new Recorder.Block<Void>() {
                    ...
                    public Void call() {
                        ...
                        if (variantData.getVariantConfiguration().getUseJack()) {
                            createJackTask(appVariantData, null);
                        } else {
