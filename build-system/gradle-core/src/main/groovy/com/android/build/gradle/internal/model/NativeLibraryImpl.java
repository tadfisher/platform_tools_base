...
public class NativeLibraryImpl implements NativeLibrary, Serializable{
    ...
    public NativeLibraryImpl(
            ...
            @NonNull List<File> solibSearchPaths) {
        this.name = name;
        ...
        this.solibSearchPaths = solibSearchPaths;
    }
    ...
    @NonNull
    @Override
    public List<File> getSolibSearchPath() {
        return solibSearchPaths;
    }
    ...
    public String toString() {
        return "NativeLibraryImpl{" +
                ...
                ", solibSearchPaths=" + solibSearchPaths +
                '}';
    }
}
