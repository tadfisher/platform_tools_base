...
*/
    ...
    private PrepareLibraryTask maybeCreatePrepareLibraryTask(
        ...
        if (prepareLibraryTask == null) {
            prepareLibraryTask = taskProject.getTasks().create(taskName, PrepareLibraryTask.class);
            ...
            if (projectPath != null) {
                ...
                prepareLibraryTask.dependsOn(project.getDependencies().project(projectInfo));
            }
            ...
            if (moduleArtifacts != null) {
                for (ResolvedArtifact artifact : moduleArtifacts) {
                    if (EXT_LIB_ARCHIVE.equals(artifact.getExtension())) {
                        ...
                        File explodedDir = project.file(project.getRootProject().getBuildDir()
