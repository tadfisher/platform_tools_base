...
public class TaskInfoRegistry {
    ...
    public TaskInfoRegistry() {
        ...
        register(TaskType.ABSTRACT_COMPILE,      AbstractCompile.class,     "compile",  "JavaWithJavac", TaskInfo.Scope.VARIANT);
        register(TaskType.OBFUSCATION,           Task.class,                "proguard", "",              TaskInfo.Scope.VARIANT);
        register(TaskType.PROCESSJAVARESOURCES,  Copy.class,                "process",  "JavaRes",       TaskInfo.Scope.VARIANT);
