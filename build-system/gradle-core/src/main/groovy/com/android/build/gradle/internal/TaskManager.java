...
public abstract class TaskManager {
    ...
    private void createUnitTestTask(
        ...
        final TestVariantData variantData = (TestVariantData)variantScope.getVariantData();
        ...
        runTestsTask.setTestClassesDir(variantScope.getJavaOutputDir());
                ...
                new Callable<ConfigurableFileCollection>() {
                    ...
                    public ConfigurableFileCollection call() throws Exception {
                        ...
                        return project.files(
                                testedVariantData.getScope().getJavaOuptuts(),
                                variantScope.getJavaOuptuts(),

                                new File(variantScope.getSourceFoldersJavaResDestinationDir(),
                                        "src"),
