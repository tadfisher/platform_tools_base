...
public abstract class TaskManager {
     ...
     * 1. {@link ExtractJavaResourcesTask} will extract all java resources from packaged jar files
     * dependencies. Each jar file will be extracted in a separate folder. Each folder will be
     * located under {@link VariantScope#getPackagedJarsJavaResDestinationDir()}
     * 2. {@link ProcessJavaResConfigAction} will sync all source folders into a single folder
     * identified by {@link VariantScope#getSourceFoldersJavaResDestinationDir()}
     * 3. {@link MergeJavaResourcesTask} will take all these folders and will create a single
     * merged folder with the {@link PackagingOptions} settings applied. The folder is located at
     * {@link VariantScope#getJavaResourcesDestinationDir()}
     *
