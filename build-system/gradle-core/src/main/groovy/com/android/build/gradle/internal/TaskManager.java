...
public abstract class TaskManager {
    ...
    protected void createDataBindingTasks(@NonNull TaskFactory tasks, @NonNull VariantScope scope) {
        AndroidTask<DataBindingExportInfoTask> task = androidTasks
                .create(tasks, new DataBindingExportInfoTask.ConfigAction(scope, true));
        task.dependsOn(tasks, scope.getGenerateRClassTask());
    }
