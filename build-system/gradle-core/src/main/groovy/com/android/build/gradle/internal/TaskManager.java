...
public abstract class TaskManager {
     ...
     *
     * @param tasks  the non-null TaskFactory.
    ...
    public void createSplitResourcesTasks(@NonNull VariantScope scope) {
        ...
        assert variantData.getSplitHandlingPolicy().equals(
    ...
    public void createPostCompilationTasks(TaskFactory tasks, @NonNull final VariantScope scope) {
        ...
        pcData.setLibraryGeneratingTask(Collections.singletonList(
        ...
        if (outFile != null) {
            ...
            pcData.setLibraryGeneratingTask(Collections.singletonList(preDexTask.getName()));
        ...
        if (isMultiDexEnabled && isLegacyMultiDexMode) {
            if (!isMinifyEnabled) {
                ...
                pcData.setLibraryGeneratingTask(Collections.singletonList(jarMergingTask.getName()));
                pcData.setClassGeneratingTask(Collections.singletonList(jarMergingTask.getName()));
