...
public class VariantScope {
    ...
    @NonNull
    private Map<Abi, File> ndkSolibSearchPath = Maps.newHashMap();
     ...
     */
    @Nullable
    public File getNdkSolibSearchPath(@NonNull Abi abi) {
        return ndkSolibSearchPath.get(abi);
    }

    public void addNdkSolibSearchPath(@NonNull Abi abi, @NonNull File searchPath) {
