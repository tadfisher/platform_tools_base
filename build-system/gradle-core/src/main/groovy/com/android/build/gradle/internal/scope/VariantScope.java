...
public class VariantScope {
    ...
    @Nullable
    private AndroidTask<? extends AbstractCompile> activeJavaCompileTask;
    @Nullable
    ...
    @Nullable
    public AndroidTask<? extends AbstractCompile> getActiveJavaCompileTask() {
        return activeJavaCompileTask;
    }
    ...
    public void setActiveJavaCompileTask(
            @NonNull AndroidTask<? extends AbstractCompile> javaCompileTask) {
        this.activeJavaCompileTask = javaCompileTask;
    }
