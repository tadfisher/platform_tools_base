...
public class VariantScope {
    ...
    /**
     * Returns the {@link com.android.builder.signing.SignedJarBuilder.IZipEntryFilter} instance
     * that manages the variant list of packaged files depending on the variant's
