...
public class VariantManager implements VariantModel {
    ...
    private SigningConfig createSigningOverride() {
        if (AndroidGradleOptions.getSigningStoreType(project) != null
            && AndroidGradleOptions.getSigningStorePassword(project) != null
            && AndroidGradleOptions.getSigningKeyAlias(project) != null
            && AndroidGradleOptions.getSigningKeyPassword(project) != null) {
