...
public class GradleProcessExecutor implements ProcessExecutor {
    ...
    public ProcessResult execute(
        ...
        try {
            ...
            return new FailedGradleProcessResult(e, result);
        }
    ...
    private static class FailedGradleProcessResult implements ProcessResult {
        ...
        FailedGradleProcessResult(
                @NonNull ProcessException processException,
                @NonNull ExecResult result) {
