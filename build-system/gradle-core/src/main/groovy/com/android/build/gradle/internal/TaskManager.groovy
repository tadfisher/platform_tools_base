...
import com.android.build.gradle.tasks.factory.PackageAppConfigAction
import com.android.build.gradle.tasks.factory.ZipAlignConfigAction
    ...
    public void createPackagingTask(
        ...
        for (ApkVariantOutputData vod : variantData.outputs) {
            ...
            AndroidTask<PackageApplication> packageApp = androidTasks.create(
                    tasks,
                    "package${outputName.capitalize()}",
                    PackageApplication,
                    new PackageAppConfigAction(variantOutputScope));

            packageApp.dependsOn(tasks,
                    variantOutputData.processResourcesTask,
                    variantData.processJavaResourcesTask,
                    variantOutputScope.getNdkBuildable());
            ...
            if (signedApk) {
                if (variantData.zipAlignEnabled) {
                    AndroidTask<ZipAlign> zipAlignTask = androidTasks.create(
                            ...
                            ZipAlign,
                            new ZipAlignConfigAction(variantOutputScope));
            ...
            if (publishApk) {
                String projectBaseName = variantScope.projectBaseName;
