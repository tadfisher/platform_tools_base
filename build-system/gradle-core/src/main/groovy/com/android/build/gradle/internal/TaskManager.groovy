...
abstract class TaskManager {
    ...
    public void createAndroidTestVariantTasks(
        ...
        createInstrumentalTestForVariantData(tasks, variantData, false)
    }
    ...
    public void createConnectedCheckTasks(TaskFactory tasks, boolean hasFlavors) {
    ...
    private void createInstrumentalTestForVariantData(
            TaskFactory tasks,
