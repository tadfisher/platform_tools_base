...
abstract class TaskManager {
    ...
    public MergeResources basicCreateMergeResourcesTask(
        ...
        mergeResourcesTask.useNewCruncher =
            getExtension().aaptOptions.useNewCruncher
        ...
        mergeResourcesTask.outputDir = project.file(outputLocation)
    ...
    public void createBuildConfigTask(
        ...
        generateBuildConfigTask.buildTypeName =
            variantConfiguration.buildType.name

        generateBuildConfigTask.flavorName =
    ...
    public void createProcessResTask(
        ...
        for (BaseVariantOutputData vod : variantData.outputs) {
            ...
            processResources.resourceConfigs =
                config.mergedFlavor.resourceConfigurations
    ...
    public void createAidlTask(
        ...
        compileTask.sourceDirs = variantConfiguration.aidlSourceList
        compileTask.importDirs = variantConfiguration.aidlImports
    ...
    public void createJackTask(
        ...
        compileTask.tempFolder =
            new File("$buildDir/${FD_INTERMEDIATES}/tmp/jack/${config.dirName}")
    ...
    public void createPackagingTask(
        ...
        for (ApkVariantOutputData vod : variantData.outputs) {
            ...
            if (config.minifyEnabled && config.buildType.shrinkResources && !config.useJack) {
                ...
                packageApp.resourceFile = shrinkTask.compressedResources
            } else {
                packageApp.resourceFile =
            ...
            packageApp.packagedJars = androidBuilder.getPackagedJars(config)
