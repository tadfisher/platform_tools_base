...
public class UnitTestConfigAction implements TaskConfigAction<Test> {
    ...
    public void execute(Test runTestsTask) {
        ...
        ConventionMappingHelper.map(runTestsTask, "classpath",
                new Callable<ConfigurableFileCollection>() {
                    ...
                    public ConfigurableFileCollection call() throws Exception {
                        ...
                        return scope.getGlobalScope().getProject().files(classpaths.toArray());
                    }
                });
        ...
        scope.getGlobalScope().getExtension().getTestOptions().getUnitTests().applyConfiguration(runTestsTask);
