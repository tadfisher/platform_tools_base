...
import static com.android.build.gradle.tasks.factory.JavaCompileConfigAction.configureLanguageLevel;
        ...
        public void execute(JackTask jackTask) {
            ...
            if (scope.getTestedVariantData() instanceof ApplicationVariantData) {
                ConventionMappingHelper.map(jackTask, "classpath", new Callable<FileCollection>() {
                    ...
                    public FileCollection call() throws Exception {
                        return scope.getGlobalScope().getProject().files(
                                ...
                                scope.getTestedVariantData().getScope().getJillRuntimeLibrariesDir(),
                ...
                ConventionMappingHelper.map(jackTask, "classpath", new Callable<FileCollection>() {
                    @Override
                    public FileCollection call() throws Exception {
                        return scope.getGlobalScope().getProject().files(scope.getJillRuntimeLibrariesDir());
                    }
                });
            }
            ...
            configureLanguageLevel(scope, jackTask);
        }
    }
}
