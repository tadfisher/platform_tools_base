...
public class GlobalScope {
    ...
    private final DexFile dexFileElement;
    ...
    // may not be useful.
    public GlobalScope(DexFile dexFileElement, File dexFile, AndroidModel model) {
        this.dexFileElement = dexFileElement;
        this.dexFile = dexFile;
        this.androidModel = model;
    }

    public DexFile getDexBuildableElement() {
        return dexFileElement;
    }
}
