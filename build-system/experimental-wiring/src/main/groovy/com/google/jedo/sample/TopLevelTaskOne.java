...
public class TopLevelTaskOne extends DefaultTask implements ScopedTask<GlobalScope> {
    ...
    public void apply() {
        ...
        try {
            ...
            fileReader = new FileReader(dexFile.get());
            charBuffer = new char[1024];
            System.out.println("I read " + fileReader.read(charBuffer) + " characters from dex");
            fileReader.close();
            System.out.println("I got " + new String(charBuffer));
    ...
    public void initializeWith(GlobalScope scope) {
        this.dexFile = scope.getDexBuildableElement();
        this.inputFile = scope.getDexFile();
