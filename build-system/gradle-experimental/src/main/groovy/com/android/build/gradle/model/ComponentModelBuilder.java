...
public class ComponentModelBuilder implements ToolingModelBuilder {
    ...
    private ModelBuilder createModelBuilder() {
        ...
        // FIXME: This forces all the rules to run, but will also creates all the tasks.
        // To fix this, we need to:
        //   - Modify ModelBuilder to not require any task to be created
        //   - Design component plugin in such a way that all data required by ModelBuilder can
        //     be obtained by realizing a subset of models *without* creating any task.
        // We will wait for Gradle to properly design how component model is suppose to interact
        // with Tooling Model before proceeding on redesigning the plugin.
        //registry.realizeNode(new ModelPath("tasks"));
        registry.realizeNode(new ModelPath("binaries"));
        //registry.realize(ModelPath.path("tasks"), DefaultCollectionBuilder.typeOf(Task.class));
