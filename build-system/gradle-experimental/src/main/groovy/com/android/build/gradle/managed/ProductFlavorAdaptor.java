 ...
 */
public class ProductFlavorAdaptor implements GradleProductFlavor {

    @NonNull
    protected final ManagedProductFlavor productFlavor;

    public ProductFlavorAdaptor(@NonNull ManagedProductFlavor productFlavor) {
