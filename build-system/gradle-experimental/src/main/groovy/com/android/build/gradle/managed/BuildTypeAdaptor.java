 ...
 */
public class BuildTypeAdaptor implements GradleBuildType {
    @NonNull
    private final ManagedBuildType buildType;

    public BuildTypeAdaptor(@NonNull ManagedBuildType buildType) {
