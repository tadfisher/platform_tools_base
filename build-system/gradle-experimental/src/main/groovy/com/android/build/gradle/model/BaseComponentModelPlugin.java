...
public class BaseComponentModelPlugin implements Plugin<Project> {
    ...
    public static class Rules extends RuleSource {
        ...
        public ExtraModelInfo createExtraModelInfo(Project project,
        ...
        public com.android.build.gradle.AndroidConfig createModelAdaptor(
                ServiceRegistry serviceRegistry, AndroidConfig androidExtension, Project project,
        ...
        public void createAndroidComponents(AndroidComponentSpec androidSpec,
                ...
                @Path("android.signingConfigs") ManagedSet<SigningConfig> signingConfigs,
                VariantFactory variantFactory, TaskManager taskManager, Project project,
                AndroidBuilder androidBuilder, SdkHandler sdkHandler, ExtraModelInfo extraModelInfo,
                @Path("isApplication") Boolean isApplication) {
            Instantiator instantiator = serviceRegistry.get(Instantiator.class);
        ...
        @Mutate
        public void createVariantData(CollectionBuilder<AndroidBinary> binaries,
        ...
        @Mutate
        public void createBinaryTasks(final CollectionBuilder<Task> tasks, BinaryContainer binaries,
                AndroidComponentSpec spec, TaskManager taskManager) {
