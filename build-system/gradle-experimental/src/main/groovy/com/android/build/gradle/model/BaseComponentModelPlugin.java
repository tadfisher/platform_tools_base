...
public class BaseComponentModelPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        try {
            ...
            String benchmarkName = (String) project.getProperties().get("RECORD_BENCHMARK_NAME");
            if (benchmarkName != null) {
                propertyList.add(new Recorder.Property("benchmark_name", benchmarkName));
            }
            String benchmarkMode = (String) project.getProperties().get("RECORD_BENCHMARK_MODE");
