 ...
 */
public class SigningConfigAdaptor implements SigningConfig {

    @NonNull
    private final ManagedSigningConfig signingConfig;

    public SigningConfigAdaptor(@NonNull ManagedSigningConfig signingConfig) {
