...
public class StlConfiguration {
    ...
    private static final Map<String, Collection<String>> STL_SOURCES;
    static {
        STL_SOURCES = ImmutableMap.<String, Collection<String>>builder()
                .put("system", ImmutableList.of(
                        "system/include"))
                .put("stlport", ImmutableList.of(
                        "stlport/stlport",
                        "gabi++/include"))
                .put("gnustl", ImmutableList.of(
                        "gnu-libstdc++",
                        "gnu-libstdc++/4.6/include",
                        "gnu-libstdc++/4.6/libs/armeabi-v7a/include",
                        "gnu-libstdc++/4.6/include/backward"))
                .put("gabi++", ImmutableList.of(
                        "gabi++",
                        "gabi++/include"))
