 ...
 */
public interface ManagedProductFlavor {

    String getName();
    void setName(String name);

    @Nullable
    ManagedSet<ManagedClassField> getBuildConfigFields();

    @Nullable
    ManagedSet<ManagedClassField> getResValues();
    ...
    @Nullable
    ManagedApiVersion getMinSdkVersion();

    @Nullable
    ManagedApiVersion getTargetSdkVersion();
    ...
    ManagedSigningConfig getSigningConfig();
    void setSigningConfig(ManagedSigningConfig signingConfig);

    Boolean getUseJack();
    void setUseJack(Boolean useJack);

    ManagedNdkConfig getNdkConfig();
}
