...
import static com.android.tools.gradle.eclipse.EclipseImport.ANDROID_GRADLE_PLUGIN;
import static com.android.tools.gradle.eclipse.EclipseImport.IMPORT_SUMMARY_TXT;
import static com.android.tools.gradle.eclipse.EclipseImport.NL;
...
public class EclipseImportTest extends TestCase {
    ...
    private static File createLibrary(File root, String lib2Pkg) throws IOException {
        ...
        createAndroidManifest(lib1, lib1Pkg, -1, -1, null);
        ...
        createAndroidManifest(lib2, lib2Pkg, 7, -1, null);
    ...
    public void testOptions() throws Exception {
        ...
        File imported = checkProject(projectDir, ""
                ...
                new ImportCustomizer() {
                    @Override
                    public void customize(EclipseImport importer) {
                        importer.setLowerCaseModules(false);
    ...
    interface ImportCustomizer {
        void customize(EclipseImport importer);
    }
    ...
    private static File checkProject(File adtProjectDir,
        ...
        assertTrue(EclipseImport.isAdtProjectDir(adtProjectDir));
        List<File> projects = Collections.singletonList(adtProjectDir);
        EclipseImport importer = new EclipseImport();
        if (customizer != null) {
