...
class SvgTree {
    ...
    // Although we keep all of the error logs, but we only display a limited number
    // of them.
    ...
    public String getErrorLog() {
        ...
        for(String log: mErrorLines) {
            ...
            counter++;
            if (counter > MAX_DISPLAY_ERROR_LOG_SIZE) {
                errorBuilder.append("Too long, skipping now ... \n");
                break;
            }
        }
