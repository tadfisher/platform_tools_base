...
public class PkgDescTest extends TestCase {
    ...
    public final void testPkgDescExtra() {
        ...
        assertEquals("<PkgDesc Vendor=vendor Path=extra_path FullRev=1.2.3>", p.toString());
    ...
    public final void testPkgDescAddon() throws Exception {
        ...
        assertEquals("<PkgDesc Android=API 19 Vendor=vendor Path=vendor:addon_name:19 MajorRev=1>",
                     p1.toString());
