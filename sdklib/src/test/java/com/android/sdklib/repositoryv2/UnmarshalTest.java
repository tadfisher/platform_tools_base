...
import com.android.sdklib.repositoryv2.generated.repository.ObjectFactory;
...
public class UnmarshalTest extends TestCase {
    ...
    public void testLoadRepo12() throws Exception {
        ...
        RepoXsdUtil.registerSourceCategory(new SdkSourceCategory(ObjectFactory.class,
                new File(
                        AndroidLocalSdkHandler.class.getResource("sdk-repository-12.xsd").toURI())));
        mySchema = sf.newSchema(RepoXsdUtil.getXsdStreams(
                RepoXsdUtil.getSourceCategory(new File(getClass().getResource(filename).toURI()))));
