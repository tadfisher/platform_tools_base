...
public class UpdaterDataTest extends SdkManagerTestCase {
    ...
    public final void testAcceptLicenses_NoAnswer() {
        ...
        assertEquals(
                ...
                "\n" +
                "\n" +
                ", P Do you accept the license 'sdk-license' [y/n]: , P \n" +
                ", P Unknown response ''.\n" +
                ", P Do you accept the license 'sdk-license' [y/n]: , P \n" +
                ", P Unknown response ''.\n" +
                ", P Do you accept the license 'sdk-license' [y/n]: , P \n" +
                ", P Unknown response ''.\n" +
                ", P Max number of retries exceeded. Rejecting 'sdk-license'\n" +
                ", P Package MockEmptyPackage 'test' not installed due to rejected license 'sdk-license'.\n" +
