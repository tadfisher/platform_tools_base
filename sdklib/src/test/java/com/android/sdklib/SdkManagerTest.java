...
public class SdkManagerTest extends SdkManagerTestCase {
    ...
    public void testSdkManager_SystemImage() throws Exception {
        ...
        assertEquals(
                "[SystemImage ABI=armeabi, location in system image='$SDK/system-images/android-0/default/armeabi', " +
                 "SystemImage ABI=armeabi-v7a, location in system image='$SDK/system-images/android-0/default/armeabi-v7a', " +
                 "SystemImage ABI=x86, location in platform subfolder='$SDK/platforms/v0_0/images/x86']",
                cleanPath(sdkman, Arrays.toString(t.getSystemImages())));
        ...
        assertEquals(
                "[SystemImage ABI=armeabi, location in system image='$SDK/system-images/android-0/default/armeabi', " +
                 "SystemImage ABI=armeabi-v7a, location in system image='$SDK/system-images/android-0/default/armeabi-v7a', " +
                 "SystemImage ABI=armeabi-v7a, location in system image='$SDK/system-images/android-0/tag-1/armeabi-v7a', " +
                 "SystemImage ABI=x86, location in platform subfolder='$SDK/platforms/v0_0/images/x86']",
                cleanPath(sdkman, Arrays.toString(t.getSystemImages())));
    }
    ...
    public void testSdkManager_SystemImage_LegacyOverride() throws Exception {
        ...
        assertEquals(
                "[SystemImage ABI=armeabi, location in platform legacy='$SDK/platforms/v0_0/images', " +
                 "SystemImage ABI=x86, location in system image='$SDK/system-images/android-0/default/x86']",
                cleanPath(sdkman, Arrays.toString(t.getSystemImages())));
