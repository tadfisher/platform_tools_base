...
public class LocalSdkTest extends TestCase {
    ...
    public final void testLocalSdkTest_getPkgInfo_Platforms() {
        ...
        assertEquals("[<LocalPlatformPkgInfo MajorRev=1 Target=android-18>]",
        ...
        IAndroidTarget t = ls.getTargetFromHashString("android-18");
        assertSame(t, ((LocalPlatformPkgInfo) pi).getAndroidTarget());
        assertNotNull(t);
    }
    ...
    public final void testLocalSdkTest_getPkgInfo_Addons() {
        ...
        assertEquals("[<LocalAddonPkgInfo MajorRev=2 Path=Some Vendor:Some Name:18 Target=android-18>]",
