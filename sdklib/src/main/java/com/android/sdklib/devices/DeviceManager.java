...
public class DeviceManager {
    ...
    public static String hasHardwarePropHashChanged(@NonNull Device d, @NonNull String hashV2) {
        ...
        // the future we decide to change it, we could do potentially recompute the hash
        // using an older digest method here and still determine its validadity, whereas the
