...
public class RenderScriptProcessor {
    ...
    private final static class Abi {
        ...
        @NonNull
        private final String mPrebuilts;
        @NonNull
    ...
    private static final Abi[] ABIS = {
            new Abi("armeabi-v7a", "armv7-none-linux-gnueabi", "arm", BuildToolInfo.PathId.LD_ARM,
                    "-dynamic-linker", "/system/bin/linker", "-X", "-m", "armelf_linux_eabi"),
            new Abi("mips", "mipsel-unknown-linux", "mips", BuildToolInfo.PathId.LD_MIPS, "-EL"),
            new Abi("x86", "i686-unknown-linux", "x86", BuildToolInfo.PathId.LD_X86, "-m", "elf_i386") };
    ...
    public RenderScriptProcessor(
        ...
        if (supportMode) {
            ...
            mLibClCore = new File(new File(mRsLib, "arm"), "libclcore.bc");
        } else {
            mLibClCore = null;
            mRsLib = null;
        }
        ...
        if (oldOutputs != null) {
            for (File file : oldOutputs) {
                ...
                if (mSupportMode && file.getName().endsWith(SdkConstants.DOT_BC)) {
                    ...
                    String soName = name.replaceAll("\\.bc", ".so");
    ...
    private void createSupportLibFile(
        ...
        File prebuiltsFolder = new File(mRsLib, abi.mPrebuilts);
        ...
        args.add("-L" + prebuiltsFolder.getAbsolutePath());
...
//        args.add("-rpath");
        ...
        args.add(new File(prebuiltsFolder, "libcompiler_rt.a").getAbsolutePath());
