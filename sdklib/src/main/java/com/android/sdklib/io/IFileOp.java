...
public interface IFileOp {
    ...
    /**
     * Returns the file name (the last segment of the file path).
     *
     * @see File#getName
     * @param fileOrFolder The file or folder of which to get the path.
     * @return The name string.
     */
    @NonNull
    public abstract String getName(@NonNull File fileOrFolder);
     ...
     */
    @NonNull
    public abstract String getPath(@NonNull File fileOrFolder);
     ...
     */
    @NonNull
    public abstract String getAbsolutePath(@NonNull File fileOrFolder);
     ...
     */
    public abstract boolean isSameFile(@NonNull File source, @NonNull File destination)
            throws IOException;
    ...
    public abstract OutputStream newFileOutputStream(@NonNull File file) throws FileNotFoundException;

    /** Creates a new {@link InputStream} for the given {@code file}. */
    public abstract InputStream newFileInputStream(@NonNull File file) throws FileNotFoundException;
