...
public final class SdkPackages {
    ...
    @NonNull
    public Map<String, LocalPackage> getLocalPkgInfos() {
    ...
    void setLocalPkgInfos(Map<String, LocalPackage> packages) {
        mLocalPackages = packages;
        computeUpdates();
    }

    // TODO: note that packages must be compatible
    void setRemotePkgInfos(Multimap<String, RemotePackage> packages) {
