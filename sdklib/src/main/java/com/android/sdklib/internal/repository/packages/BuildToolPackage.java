...
//
//        BuildToolPackage ptp = new BuildToolPackage(source, props, revision, license,
//                description, descUrl, archiveOs, archiveArch, archiveOsPath);
//
//        File buildToolsFolder = new File(archiveOsPath);
//        String error = null;
//
//        if (error != null) {
...
//                    "Broken Build-Tools Package: %1$s\n" +
...
//    }
    ...
    public boolean sameItemAs(Package pkg) {
        return sameItemAs(pkg, true /*ignorePreviews*/);
    }
    ...
    public boolean sameItemAs(Package pkg, boolean ignorePreviews) {
        ...
        if (pkg instanceof BuildToolPackage) {
            ...
            return rhs.getRevision().compareTo(getRevision(), ignorePreviews) == 0;
        }
        return false;
    }
