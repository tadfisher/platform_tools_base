...
public class LocalSdk {
    ...
    public LocalPkgInfo getPkgInfo(int filter, FullRevision revision) {
        ...
        Preconditions.checkArgument(filter == PKG_TOOLS || filter == PKG_PLATFORM_TOOLS ||
                                    filter == PKG_BUILD_TOOLS);
    ...
    public LocalPkgInfo getPkgInfo(int filter, MajorRevision revision) {
        ...
        Preconditions.checkArgument(filter == PKG_DOCS || filter == PKG_EXTRAS);
