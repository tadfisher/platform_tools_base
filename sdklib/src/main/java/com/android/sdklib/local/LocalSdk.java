 ...
 *     or {@code getPkgInfo(PKG_EXTRAS, String)} => {@link LocalPkgInfo}</td>
 * </tr>
 *
 * <tr>
 * <td>Sources</td>
 * <td>{@link AndroidVersion}</td>
 * <td>{@code getPkgsInfo(PKG_SOURCES, AndroidVersion)} => {@link LocalPkgInfo}, <br/>
 ...
 * <td>Samples</td>
 * <td>{@link AndroidVersion}</td>
 * <td>{@code getPkgsInfo(PKG_SAMPLES, AndroidVersion)} => {@link LocalPkgInfo}, <br/>
 ...
 * <td>Platforms</td>
 * <td>{@link AndroidVersion}</td>
 * <td>{@code getPkgsInfo(PKG_PLATFORMS, AndroidVersion)} => {@link LocalPkgInfo}, <br/>
 ...
 * <td>Add-ons</td>
 * <td>{@link AndroidVersion}</td>
 * <td>{@code getPkgsInfo(PKG_ADDONS, AndroidVersion)} => {@link LocalPkgInfo}, <br/>
...
public class LocalSdk {
     ...
     *
     * @param filter {@link #PKG_PLATFORMS}, {@link #PKG_ADDONS},
    ...
    public LocalPkgInfo getPkgInfo(int filter, AndroidVersion version) {
        ...
        Preconditions.checkArgument(filter == PKG_PLATFORMS || filter == PKG_ADDONS ||
                                    filter == PKG_SAMPLES || filter == PKG_SOURCES);
    ...
    public LocalPkgInfo getPkgInfo(int filter, FullRevision revision) {
        ...
        Preconditions.checkArgument(filter == PKG_BUILD_TOOLS);
    ...
    public LocalPkgInfo getPkgInfo(int filter, String vendorPath) {
        ...
        Preconditions.checkArgument(filter == PKG_EXTRAS);
    ...
    public LocalPkgInfo getPkgInfo(int filter) {
        ...
        Preconditions.checkArgument(filter == PKG_TOOLS ||
