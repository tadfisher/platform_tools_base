...
/**
 * Local system-image package, for a given addon's {@link AndroidVersion}
 * and given ABI.
...
public class LocalAddonSysImgPkgInfo extends LocalPkgInfo {
    ...
    public LocalAddonSysImgPkgInfo(@NonNull LocalSdk localSdk,
        ...
        IdDisplay tag = LocalSysImgPkgInfo.extractTagFromProps(sourceProps);
        mDesc = PkgDesc.Builder.newAddonSysImg(version, tag, abi, addonVendor, revision).create();
    }
