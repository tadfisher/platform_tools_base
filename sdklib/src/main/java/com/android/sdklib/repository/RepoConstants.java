...
public class RepoConstants {
     ...
     * Value format: [1-9]\.[0-9]{1,2}, e.g. "1.6", "1.7", "1.10" or "2.0"
     * @since repo-10, addon-7 and sys-img-3.
     */
     ...
     * @deprecated Use {@link #NODE_HOST_OS} instead in repo-10, addon-7 and sys-img-3.
     */
    @Deprecated
    public static final String ATTR_OS   = "os";                                //$NON-NLS-1$
    /**
     * An optional archive Architecture attribute.
     * @deprecated Use {@link #NODE_JVM_BITS} instead in repo-10, addon-7 and sys-img-3.
     */
    @Deprecated
