...
public abstract class LocalPkgInfo implements IListDescription, Comparable<LocalPkgInfo> {
     ...
     * This is only defined if {@link UpdateComputation} has been used to decorate the packages.
     *
    ...
    /**
     * Used by {@link UpdateComputation} to indicate if there's an update available for this package.
     */
    ...
    /**
     * Comparison is solely done based on the {@link PkgDesc}.
     * <p/>
     ...
     * {@link PkgDesc} but also specific local properties such a local directory,
